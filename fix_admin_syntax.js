...
function replaceFileContent(filePath, searchValue, replaceValue) {
  try {
    ...
    // Convert searchValue to string if it's regex or string
    let matched = false;
    ...
    if (matched) {
      ...
      console.log(\ℹ️ Not found in \, skipping\);
    }
  } catch (err) {
...
// 3. Fix PricingAndPlanPage.tsx CustomLicenseData Icon import
