        ...
        <div className="max-w-4xl mx-auto px-6 py-12">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 mb-4">
              ...
              <span className="text-sm font-medium text-emerald-800 dark:text-emerald-400">D-Secure</span>
            </div>
                ...
                <div className="bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 rounded-lg p-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-2">
                      <svg className="w-5 h-5 text-emerald-800 dark:text-emerald-400" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
                        <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
                      </svg>
                      <a href="mailto:privacy@dsecuretech.com" className="text-emerald-800 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300 font-semibold">
                        privacy@dsecuretech.com
                      </a>
                    </div>
                    <div className="flex items-start gap-2">
                      <svg className="w-5 h-5 text-emerald-800 dark:text-emerald-400 mt-1" fill="currentColor" viewBox="0 0 20 20">
