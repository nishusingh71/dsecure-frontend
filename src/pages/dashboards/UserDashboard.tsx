...
const devLog = (...args: any[]) => {
  if (!isDemoMode()) console.log(...args);
};
const devWarn = (...args: any[]) => {
  if (!isDemoMode()) console.warn(...args);
};
const devError = (...args: any[]) => {
  if (!isDemoMode()) console.error(...args);
};
...
export default function UserDashboard() {
  ...
  useEffect(() => {
    const fetchProfileData = async () => {
      try {
        ...
        const userType =
          parsedData.user_type || parsedData.userType || user?.role;
        ...
        if (isSubuser) {
          ...
          const subuserEmail =
            parsedData.user_email || parsedData.email || user?.email;
          ...
          setProfileData({
            name:
              parsedData.user_name || parsedData.name || user?.name || "User",
            email:
              parsedData.user_email || parsedData.email || user?.email || "",
            role:
              parsedData.user_role || parsedData.role || user?.role || "User",
            department: parsedData.department || user?.department,
            phone: parsedData.phone_number || user?.phone_number,
            isSubuser: false,
          });
  ...
  const displayedCertificates = expandedSections.certificates
    ? certificates
  ...
  const quickActions = [
    {
      name: "Start New Erasure",
      icon: "play",
      type: "primary",
      action: () => navigate("/admin/new-erasure"),
    },
    {
      name: "Download Agent",
      icon: "download",
      type: "secondary",
      action: () => navigate("/admin/download-agent"),
    },
    {
      name: "View Reports",
      icon: "chart",
    ...
    },
    {
      ...
      action: () =>
        showInfo(
          "Feature Coming Soon",
          "Bulk Operations feature is currently in development",
        ),
    },
    {
      ...
      action: () =>
        showInfo(
          "Feature Coming Soon",
          "Schedule Erasure feature is currently in development",
        ),
    },
    {
      ...
      action: () =>
        showInfo(
          "Feature Coming Soon",
          "Compliance Check feature is currently in development",
        ),
    },
    {
      name: "Export Data",
  ...
  const displayedQuickActions = expandedSections.quickActions
    ? quickActions
  ...
  return (
    <>
      ...
      <Helmet>
        <link
          rel="canonical"
          href="https://dsecuretech.com/admin/userdashboard"
        />
        <title>
          {t(
            "dashboard.userDashboard.dsecuretech_compliance_data_erasure_standards",
          )}
        </title>
        <meta
          name="description"
      ...
      <div className="container-app py-12">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative" ref={profileMenuRef}>
              <button
                ...
                aria-label={t("dashboard.userDashboard.profile_settings")}
              >
                <svg
              ...
              {showProfileMenu && (
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-slate-200 py-1 z-50">
                  ...
                  <button className="w-full px-4 py-2 text-left text-sm text-slate-700 hover:bg-slate-50 flex items-center gap-3">
                    ...
                    {t("dashboard.userDashboard.edit_profile")}
                  </button>
                  <button className="w-full px-4 py-2 text-left text-sm text-slate-700 hover:bg-slate-50 flex items-center gap-3">
                    <svg
                      className="w-4 h-4"
                    ...
                    {t("dashboard.userDashboard.account_settings")}
                  </button>
                  <button className="w-full px-4 py-2 text-left text-sm text-slate-700 hover:bg-slate-50 flex items-center gap-3">
                    <svg
                      className="w-4 h-4"
                    ...
                    {t("dashboard.userDashboard.billing_usage")}
                  </button>
                  ...
                  >
                    ...
                    {t("dashboard.userDashboard.sign_out")}
                  </button>
                </div>
              )}
            </div>
            ...
            >
              ...
              {t("dashboard.userDashboard.start_new_erasure")}
            </Link>
          </div>
        </div>
          ...
          <Reveal delayMs={0}>
            <div className="card !p-6">
              <div className="flex items-center gap-2 text-sm font-medium text-slate-600">
                ...
                {t("dashboard.userDashboard.monthly_erasures")}
              </div>
              <div className="mt-2 flex items-end gap-2">
                <div className="text-3xl font-bold text-slate-900">
                  {stats.monthlyErasures}
                </div>
          ...
          <Reveal delayMs={10}>
            <div className="card !p-6">
              <div className="flex items-center gap-2 text-sm font-medium text-slate-600">
                ...
                {t("dashboard.userDashboard.total_devices")}
              </div>
              <div className="mt-2 flex items-end gap-2">
                <div className="text-3xl font-bold text-slate-900">
                  {stats.totalDevices}
          ...
          <Reveal delayMs={20}>
            <div className="card !p-4 sm:!p-6 min-w-0">
              <div className="flex items-center gap-2 text-sm font-medium text-slate-600">
                ...
                {t("dashboard.userDashboard.success_rate")}
              </div>
              <div className="mt-2 flex items-end gap-2">
                <div className="text-3xl font-bold text-slate-900">
                  {stats.successRate}
          ...
          <Reveal delayMs={30}>
            <div className="card !p-4 sm:!p-6 min-w-0">
              <div className="flex items-center gap-2 text-sm font-medium text-slate-600">
                ...
                {t("dashboard.userDashboard.storage_reclaimed")}
              </div>
              <div className="mt-2 flex items-end gap-2">
                <div className="text-3xl font-bold text-slate-900">
                  {stats.storageReclaimed}
                </div>
                <div className="text-sm text-green-600 mb-1 flex items-center gap-1">
                  <svg
                    className="w-4 h-4"
        ...
        <div className="mt-8">
          <div className="flex items-center justify-between mb-4">
            <h2 className="font-semibold text-slate-900">
              {t("dashboard.userDashboard.recent_certificates")}
            </h2>
            <button
        ...
        <div className="mt-8">
          <div className="flex items-center justify-between mb-4">
            <h2 className="font-semibold text-slate-900">
              {t("dashboard.userDashboard.quick_actions")}
            </h2>
            <button
            ...
            {displayedQuickActions.map((action, i) => (
              <Reveal key={action.name} delayMs={i * 100}>
                ...
                >
                  ...
                  <div
                    className={`mt-3 sm:mt-4 text-xs sm:text-sm font-medium text-center px-2 ${
                      action.type === "primary"
                        ? "text-white"
                        : "text-slate-900"
                    }`}
