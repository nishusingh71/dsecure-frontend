            ...
            <Reveal>
              <div className="max-w-4xl">
                ...
                <p className="text-lg sm:text-xl text-slate-600 mb-8 leading-relaxed max-w-2xl">
                  ...
                  Protect patient data with certified, compliant data erasure 
            ...
            <Reveal>
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-slate-600 max-w-3xl mx-auto">
                  Meet HIPAA requirements with certified data sanitization across medical devices, 
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
              {[
                ...
                },
                {
                  ...
                  description: "Generate tamper-proof certificates for regulatory audits and compliance verification",
                  icon: (
                    <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
