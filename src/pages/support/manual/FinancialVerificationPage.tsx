...
const FinancialVerificationPage: React.FC = memo(() => {
  return (
    <>
      {/* SEO Meta Tags */}
      <SEOHead seo={getSEOForPage("support-manual-financial-verification")} />
      {/* <Helmet>
        <title>Financial Verification | D-Secure</title>
      </Helmet> 
      */}
            ...
            <Reveal>
              <div className="prose prose-lg max-w-none">
                ...
                <ul className="space-y-3 text-slate-700">
                  <li className="flex items-start"><span className="text-emerald-600 mr-2">✓</span> Comprehensive Financial Verification guide</li>
...
export default React.memo(FinancialVerificationPage);
