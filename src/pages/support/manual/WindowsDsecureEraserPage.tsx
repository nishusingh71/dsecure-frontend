...
const WindowsDsecureEraserPage: React.FC = memo(() => {
  return (
    <>
      {/* SEO Meta Tags */}
      <SEOHead seo={getSEOForPage("windows-dsecure-eraser")} />
      <Helmet>
            ...
            <Reveal>
              <div className="prose prose-lg max-w-none">
                ...
                <ul className="space-y-3 text-slate-700">
                  <li className="flex items-start"><span className="text-emerald-800 mr-2">✓</span> Comprehensive Windows Dsecure Eraser guide</li>
