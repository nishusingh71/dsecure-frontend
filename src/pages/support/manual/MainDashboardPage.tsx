            ...
            <Reveal>
              <div className="prose prose-lg max-w-none">
                ...
                <ul className="space-y-3 text-slate-700">
                  <li className="flex items-start"><span className="text-emerald-800 mr-2">✓</span> Top navigation bar with global search and user profile</li>
                  <li className="flex items-start"><span className="text-emerald-800 mr-2">✓</span> Left sidebar with feature categories and quick links</li>
                  <li className="flex items-start"><span className="text-emerald-800 mr-2">✓</span> Central workspace for active operations and data visualization</li>
                  <li className="flex items-start"><span className="text-emerald-800 mr-2">✓</span> Right panel for notifications, alerts, and system messages</li>
                </ul>
              </div>
            </Reveal>
          </div>
