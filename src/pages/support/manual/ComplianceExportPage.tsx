          ...
          <div className="container mx-auto px-4 max-w-7xl">
            <Reveal>
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-slate-900 mb-4">
                Compliance <span className="bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">Export</span>
              </h1>
            </Reveal>
          </div>
        </section>
            ...
            <Reveal>
              <div className="prose prose-lg max-w-none">
                ...
                <ul className="space-y-3 text-slate-700">
                  <li className="flex items-start"><span className="text-emerald-800 mr-2">✓</span> PDF regulatory documents</li>
                  <li className="flex items-start"><span className="text-emerald-800 mr-2">✓</span> CSV data export</li>
                </ul>
              </div>
            </Reveal>
          </div>
