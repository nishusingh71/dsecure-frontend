...
const SanitizationConceptsPage: React.FC = memo(() => {
  return (
    <>
      {/* SEO Meta Tags */}
      <SEOHead seo={getSEOForPage("support-manual-sanitization-concepts")} />
      {/* <Helmet>
        <title>Sanitization Concepts | D-Secure</title>
      </Helmet> 
      */}
            ...
            <Reveal>
              <div className="prose prose-lg max-w-none">
                ...
                <ul className="space-y-3 text-slate-700">
                  <li className="flex items-start"><span className="text-emerald-600 mr-2">✓</span> Comprehensive Sanitization Concepts guide</li>
...
export default React.memo(SanitizationConceptsPage);
