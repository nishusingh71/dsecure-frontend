    ...
    <>
      ...
      <SEOHead 
        seo={getSEOForPage("support-manual-enterprise-integration", { 
          ...
          canonicalUrl: "/support/manual/enterprise-integration" 
        })} 
      />
            ...
            <Reveal>
              <div className="prose prose-lg max-w-none">
                ...
                <ul className="space-y-3 text-slate-700">
                  <li className="flex items-start"><span className="text-emerald-800 mr-2">✓</span> Active Directory authentication</li>
                  <li className="flex items-start"><span className="text-emerald-800 mr-2">✓</span> LDAP directory services</li>
                  <li className="flex items-start"><span className="text-emerald-800 mr-2">✓</span> SIEM system integration</li>
                </ul>
              </div>
            </Reveal>
          </div>
