    ...
    <>
      ...
      <SEOHead 
        seo={getSEOForPage("support-manual-device-selection", { 
          ...
          canonicalUrl: "/support/manual/device-selection" 
        })} 
      />
            ...
            <Reveal>
              <div className="prose prose-lg max-w-none">
                ...
                <ul className="space-y-3 text-slate-700">
                  <li className="flex items-start"><span className="text-emerald-800 mr-2">✓</span> Device model, manufacturer, and serial number</li>
                  <li className="flex items-start"><span className="text-emerald-800 mr-2">✓</span> Storage capacity and interface type (SATA/NVMe/USB)</li>
                  <li className="flex items-start"><span className="text-emerald-800 mr-2">✓</span> Current status and health indicators</li>
                  <li className="flex items-start"><span className="text-emerald-800 mr-2">✓</span> Previous erasure history and timestamps</li>
                </ul>
              </div>
            </Reveal>
          </div>
