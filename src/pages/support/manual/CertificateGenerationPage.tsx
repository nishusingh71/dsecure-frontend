           ...
           <Reveal>
             <div className="text-center">
               ...
               <p className="text-xl text-slate-700 max-w-3xl mx-auto">
                 Generate tamper-proof certificates of data destruction with D-Secure's comprehensive documentation system. Create legally admissible, compliance-ready certificates with advanced security features.
               </p>
             </div>
           </Reveal>
         </div>
           ...
           <div className="space-y-12">
               ...
               <div className="bg-white rounded-xl p-8 shadow-sm border border-slate-200">
                 ...
                 <div className="grid md:grid-cols-3 gap-6">
                   <div className="bg-emerald-50 rounded-lg p-6">
                     ...
                     <h3 className="font-semibold text-slate-900 mb-3">Standard Certificate</h3>
                     <p className="text-sm text-slate-700 mb-4">Basic erasure completion certificate with essential details for routine operations</p>
                   ...
                   <div className="bg-teal-50 rounded-lg p-6">
                     ...
                     <h3 className="font-semibold text-slate-900 mb-3">Compliance Certificate</h3>
                     <p className="text-sm text-slate-700 mb-4">Detailed certificate meeting specific regulatory requirements (GDPR, HIPAA, PCI-DSS)</p>
                   ...
                   <div className="bg-cyan-50 rounded-lg p-6">
                     ...
                     <h3 className="font-semibold text-slate-900 mb-3">Forensic Certificate</h3>
                     <p className="text-sm text-slate-700 mb-4">Court-admissible certificate with cryptographic verification for legal proceedings</p>
             ...
             <Reveal>
               <div className="bg-white rounded-xl p-8 shadow-sm border border-slate-200">
                 <h2 className="text-2xl font-bold text-slate-900 mb-6 flex items-center">
                   ...
                   Certificate Components & Security Features
                 </h2>
             ...
             <Reveal>
               <div className="bg-white rounded-xl p-8 shadow-sm border border-slate-200">
                 <h2 className="text-2xl font-bold text-slate-900 mb-6 flex items-center">
                   ...
                   Certificate Formats & Distribution
                 </h2>
                 <div className="space-y-6">
             ...
             <Reveal>
               <div className="bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-600 rounded-xl p-8 text-white">
                 <div className="text-center">
                   <h2 className="text-2xl font-bold mb-4">Ready to Generate Certificates?</h2>
                   <p className="text-emerald-100 mb-6 max-w-2xl mx-auto">
                     Create tamper-proof certificates of data destruction that meet the highest compliance and legal standards.
                   </p>
