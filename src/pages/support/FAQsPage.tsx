...
const FAQsPage: React.FC = memo(() => {
  ...
  return (
    <>
      <Helmet>
        <link rel="canonical" href="https://dsecuretech.com/support/faqs" />
        <title>FAQs | DSecure Data Erasure Solutions - Common Questions</title>
        <meta
          name="description"
          content="Find answers to frequently asked questions about DSecure data erasure solutions, secure deletion methods, device compatibility, and technical support."
        />
        <meta
          name="keywords"
          content="DSecure FAQs, data erasure questions, secure deletion help, device wiping guide, technical support"
        />
