...
function SolutionsPageContent() {
  ...
  useEffect(() => {
    ...
    if (urlType) {
      ...
      } else if (urlType === 'healthcare' || urlType.includes('medical') || urlType.includes('hipaa')) {
        setActiveIndustry('healthcare')
      } else if (urlType === 'financial' || urlType.includes('banking') || urlType.includes('finance')) {
        setActiveIndustry('financial')
      } else if (urlType === 'government' || urlType.includes('public')) {
        setActiveIndustry('government')
      } else if (urlType === 'service-providers' || urlType.includes('provider')) {
