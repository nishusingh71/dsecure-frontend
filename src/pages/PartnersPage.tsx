...
import { partnerTypes } from "@/data/partnerData";
                ...
                <div className="mb-8 sm:mb-12">
                  ...
                  <div className="mb-6 sm:mb-8">
                    ...
                    <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-slate-900 mb-3 sm:mb-4">
                      ...
                      <sup className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-brand"></sup>
                    </h1>
                  ...
                  <div className="bg-white/80 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 mb-6 sm:mb-8 md:mb-10 border border-emerald-200/50 shadow-xl max-w-4xl mx-auto">
                    <p className="text-base sm:text-lg md:text-xl text-slate-700 leading-relaxed mb-2 sm:mb-4">
                      <svg
                        ...
                        className="inline w-5 h-5 text-emerald-600 mr-2"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                      >
                      ...
                      <strong>Join our Partner Program</strong> today and become
                      a part of our extensive global network!
                    </p>
                    <p className="text-sm sm:text-base md:text-lg text-slate-600 leading-relaxed">
                      Unlock new business opportunities with our best-in-class
                      cutting-edge data erasure solutions. Partner with us to
                      advance sustainability while leveraging our innovative
                  ...
                  <div className="bg-gradient-to-br from-emerald-50 via-white to-teal-50/30 border-b border-slate-200/60 p-4 sm:p-6 md:p-8">
                    <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6 mb-4 sm:mb-6">
                      <div className="w-16 sm:w-18 md:w-20 h-16 sm:h-18 md:h-20 bg-gradient-to-br from-brand via-brand-500 to-brand-600 rounded-xl sm:rounded-2xl flex items-center justify-center shadow-xl hover:scale-110 transition-transform duration-300 flex-shrink-0">
                        <svg
                          className="w-8 sm:w-9 md:w-10 h-8 sm:h-9 md:h-10 text-white"
                          fill="currentColor"
                          viewBox="0 0 24 24"
                        >
                          <path d="M12 2L2 7v10c0 5.55 3.84 9.74 9 11 5.16-1.26 9-5.45 9-11V7l-10-5z" />
                      ...
                      <div className="text-center sm:text-left flex-1">
                        <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-slate-900 via-emerald-800 to-teal-700 bg-clip-text text-transparent mb-2 sm:mb-3">
                          D-Secure
                          <sup className="text-brand text-xs sm:text-sm md:text-lg"></sup>{" "}
                    ...
                    {/* <div className="grid gap-4 sm:gap-6 mb-6 sm:mb-8">
                      <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                        <div className="w-6 sm:w-7 md:w-8 h-6 sm:h-7 md:h-8 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-md sm:rounded-lg flex items-center justify-center">
                          <svg
                            className="w-3 sm:w-3.5 md:w-4 h-3 sm:h-3.5 md:h-4 text-white"
                            fill="currentColor"
                            viewBox="0 0 24 24"
                          >
                      ...
                      <div className="grid gap-4 sm:gap-6">
                        {partnerTypes[activePartnerType].detailedBenefits?.map(
                          (benefit, index) => (
                            <div
                              key={index}
                              className="bg-white rounded-lg sm:rounded-xl shadow-lg border border-slate-200/60 hover:shadow-xl transition-all duration-300 group transform hover:-translate-y-1 overflow-hidden"
                            >
                          ...
                          partnerTypes[activePartnerType].benefits.map(
                            (benefit, index) => (
                              <div
                                key={index}
                                className="bg-white rounded-xl shadow-lg border border-slate-200/60 hover:shadow-xl transition-all duration-300 group transform hover:-translate-y-1"
                              >
                                <div className="flex items-start gap-4 p-6">
                                  ...
                                  <span className="text-slate-700 font-medium group-hover:text-slate-900 transition-colors duration-300 leading-relaxed">
                                    {benefit}
                                  </span>
                                </div>
                              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
              {[
                ...
                <Reveal key={benefit.title} delayMs={index * 150}>
                  <div
                    className={`group bg-white rounded-xl sm:rounded-2xl shadow-xl border border-slate-200/60 hover:shadow-2xl transition-all duration-500 transform hover:scale-105 hover:-rotate-1 p-4 sm:p-6 md:p-8 h-full relative overflow-hidden hover:border-emerald-300/50`}
                  >
                          ...
                          <div>
                            ...
                            <div className="space-y-1 text-sm">
                              <p>
                                ...
                                <span className="bg-emerald-100 text-emerald-700 px-2 py-1 rounded-full text-xs font-semibold ml-1">
                                  {partner.type}
                                </span>
                              </p>
                              <p>
                            ...
                            <div className="space-y-1 text-sm">
                              <p>
                                ...
                                <a
                                  ...
                                  className="text-emerald-600 hover:text-emerald-700 hover:underline ml-1 font-medium"
                                >
                ...
                <div className="mt-6 pt-6 border-t border-slate-200">
                  ...
                  <div className="flex flex-wrap gap-3">
                    <a
                      ...
                      className="bg-blue-100 text-blue-700 px-4 py-2 rounded-lg hover:bg-blue-200 transition-colors text-sm font-medium flex items-center gap-1"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="w-4 h-4"
                    ...
                    <a
                      ...
                      className="bg-green-100 text-green-700 px-4 py-2 rounded-lg hover:bg-green-200 transition-colors text-sm font-medium flex items-center gap-1"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="w-4 h-4"
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="bg-purple-100 text-purple-700 px-4 py-2 rounded-lg hover:bg-purple-200 transition-colors text-sm font-medium flex items-center gap-1"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="w-4 h-4"
