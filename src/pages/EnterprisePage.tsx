        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-lg sm:text-xl text-slate-600 mb-8 leading-relaxed max-w-2xl">
              Safeguard sensitive data with DSecure's enterprise-grade data erasure platform. Ensure compliance with global data security standards and protect your organization from data breaches with certified, permanent data erasure.
            </p>
