...
const DataGuardianAwardPage: React.FC = () => {
    ...
    const handleSearch = () => {
        if (searchQuery.trim()) {
            const results = certifiedCompanies.filter(company =>
    ...
    return (
        <>
            ...
            <SEOHead
                seo={{
                    title: "D-Secure Data Hygiene Assurance | Certified Data Protection Excellence",
                    description:
            ...
            <div className="min-h-screen bg-white">
                    ...
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                        <div className="w-full">
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
                                ...
                                <Reveal>
                                    <div>
                                        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 text-slate-900 leading-snug">
                                            D-Secure{" "}
                                        ...
                                        <p className="text-lg text-slate-600 mb-10 leading-relaxed max-w-xl">
                                            We don't just give you a certificate - we give you our assurance that your organization
                                            has the complete setup, processes, and discipline to keep data safe. This badge represents
                                            that you are a trusted, safe, and reliable partner for data security.
                                        </p>
                                ...
                                <Reveal delayMs={200}>
                                    <div className="flex justify-center items-center relative h-[480px] w-full max-w-[520px] mx-auto">
                                        ...
                                        <div className="relative z-10 bg-gradient-to-br from-white to-emerald-50/50 rounded-3xl p-8 shadow-2xl border border-emerald-100/50 backdrop-blur-sm">
                                            {/* Top Badge */}
                                            ...
                                            <div className="flex flex-col items-center pt-4">
                                                <div className="relative">
                                                    ...
                                                    <div className="w-28 h-28 bg-gradient-to-br from-emerald-500 via-emerald-600 to-teal-600 rounded-full flex items-center justify-center shadow-xl shadow-emerald-500/40">
                                                ...
                                                {/* Text */}
                                                <h3 className="text-2xl font-bold text-slate-800 mt-6">Data Hygiene</h3>
                                                <p className="text-emerald-600 font-semibold text-lg">Assurance Badge</p>
                                                ...
                                                <div className="grid grid-cols-3 gap-4 mt-2">
                                                    ...
                                                    <div className="flex flex-col items-center">
                                                        ...
                                                        <span className="text-[10px] text-slate-500 mt-1">Erasure</span>
                                                    </div>
                                                    {/* Icon 2 */}
                                                    <div className="flex flex-col items-center">
                                                        ...
                                                        <span className="text-[10px] text-slate-500 mt-1">Security</span>
                                                    </div>
                                                    {/* Icon 3 */}
                                                    <div className="flex flex-col items-center">
                            ...
                            <div className="max-w-2xl mx-auto">
                                <div className="flex gap-3 bg-white rounded-2xl p-2 shadow-2xl">
                                    ...
                                    <button
                                        ...
                                        className="bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white font-bold px-6 py-3 rounded-xl transition-all duration-300 flex items-center gap-2"
                                    >
                                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                {searchResults.length > 0 ? (
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        {searchResults.map(company => (
                                            <div key={company.id} className="bg-white rounded-xl p-6 shadow-lg">
                                                <div className="flex items-center gap-4">
                                                    <div className={`w-12 h-12 rounded-full flex items-center justify-center ${company.level === 'Gold' ? 'bg-amber-100 text-amber-600' :
                                                        company.level === 'Silver' ? 'bg-slate-100 text-slate-600' :
                                                    ...
                                                    <div>
                                                        ...
                                                        <span className={`text-xs font-semibold ${company.level === 'Gold' ? 'text-amber-600' :
                                                            company.level === 'Silver' ? 'text-slate-600' :
                                                                'text-orange-600'
                                                            }`}>{company.level} Certified</span>
                                                    </div>
                                                </div>
                                            </div>
                                        ))}
                                    ...
                                    <div className="text-center py-6 bg-white/20 rounded-xl backdrop-blur-sm">
                                        <p className="text-white">No certified companies found matching your search.</p>
                                    </div>
                                )}
                            </div>
                        )}
                ...
                <section className="py-20 md:py-28 bg-gradient-to-br from-emerald-50 via-teal-50/30 to-cyan-50">
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                        <Reveal>
                            <div className="text-center mb-16">
                                ...
                                <p className="text-lg text-slate-600 max-w-3xl mx-auto">
                                    More than a certificate - it's our assurance that your organization has the proper setup,
                                    processes, and discipline to keep sensitive data safe and secure.
                                </p>
                            </div>
                        </Reveal>
                        ...
                        {/* Feature Cards */}
                        <Reveal delayMs={100}>
                            <div className="bg-white rounded-2xl p-8 lg:p-12 shadow-xl border border-slate-200/60 w-full">
                                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                                    <div className="text-center">
                                        ...
                                        <p className="text-slate-600 text-sm">
                                            Tamper-proof certificates with digital signatures and cryptographic verification
                                        </p>
                                    </div>
                                    <div className="text-center">
                                        ...
                                        <p className="text-slate-600 text-sm">
                                            Comprehensive documentation for compliance audits and regulatory requirements
                                        </p>
                                    </div>
                                    <div className="text-center md:col-span-2 lg:col-span-1">
                                        ...
                                        <p className="text-slate-600 text-sm">
                                            Compliance with international frameworks across countries and jurisdictions
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                        <Reveal>
                            <div className="text-center mb-16">
                                ...
                                <p className="text-lg text-slate-600 max-w-3xl mx-auto">
                                    The Assurance Badge is not just about buying a product. It's about implementing a complete data hygiene process that we can audit and verify anytime.
                                </p>
                            </div>
                        </Reveal>

                        <Reveal delayMs={100}>
                            <div className="bg-white rounded-2xl p-8 lg:p-12 shadow-xl border border-slate-200/60 w-full mb-16">
                                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                                    <div className="text-center">
                                        ...
                                        <p className="text-slate-600 text-sm">
                                            Automated secure deletion that goes beyond standard recycle bin. Every deleted file is securely wiped on schedule.
                                        </p>
                                    </div>
                                    <div className="text-center">
                                        ...
                                        <p className="text-slate-600 text-sm">
                                            Monthly scheduled sanitization of all free space, eliminating any recoverable data fragments.
                                        </p>
                                    </div>
                                    <div className="text-center md:col-span-2 lg:col-span-1">
                                        ...
                                        <p className="text-slate-600 text-sm">
                                            Complete cloud & desktop reporting with timestamps and verification data for compliance.
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                        <Reveal>
                            <div className="text-center mb-16">
                                ...
                                <p className="text-lg text-slate-600 max-w-3xl mx-auto">
                                    The D-Secure Assurance Badge is trusted across all major sectors requiring secure data handling.
                                </p>
                            </div>
                        </Reveal>

                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 w-full mx-auto">
                            {[
                                { name: "Healthcare", icon: "🏥", desc: "HIPAA Compliant", color: "from-red-500 to-rose-500", bg: "bg-red-50" },
                                { name: "Finance", icon: "🏦", desc: "PCI DSS Ready", color: "from-blue-500 to-indigo-500", bg: "bg-blue-50" },
                                { name: "Government", icon: "🏛️", desc: "ISO 27001", color: "from-purple-500 to-violet-500", bg: "bg-purple-50" },
                                { name: "Education", icon: "🎓", desc: "FERPA Aligned", color: "from-amber-500 to-orange-500", bg: "bg-amber-50" },
                                { name: "Technology", icon: "💻", desc: "SOC 2 Type II", color: "from-emerald-500 to-teal-500", bg: "bg-emerald-50" },
                                { name: "Manufacturing", icon: "🏭", desc: "Industry 4.0", color: "from-slate-500 to-slate-700", bg: "bg-slate-100" },
                            ].map((industry, index) => (
                                <Reveal key={industry.name} delayMs={index * 75}>
                                    <div className={`${industry.bg} rounded-2xl p-6 border border-white hover:shadow-lg transition-all duration-300 text-center group hover:-translate-y-1`}>
                                        <div className="text-4xl mb-4 group-hover:scale-110 transition-transform">{industry.icon}</div>
                                        <h3 className="text-lg font-bold text-slate-900 mb-1">{industry.name}</h3>
                            ...
                            {[
                                {
                                    ...
                                    answer: "The D-Secure Assurance Badge is our certification that confirms your organization has implemented proper data hygiene processes. It's not just a certificate - it's our guarantee that you have the complete setup, processes, and discipline to keep data safe and secure."
                                },
                                {
                                    question: "How long does the certification process take?",
                                    answer: "The typical certification process takes 2-4 weeks, depending on your organization's size and readiness. This includes assessment, implementation support, and final verification."
                                },
                                {
                                    question: "What are the prerequisites for certification?",
                                    answer: "Organizations must implement D-Secure data hygiene tools including our automated eraser system, DSecure Recycle Bin, and Free Space Wipe. We provide complete guidance on setup and implementation."
                                },
                                {
                                    question: "How do audits work?",
                                    answer: "We conduct both scheduled and random audits to verify compliance. This includes checking erasure logs, process documentation, and system configurations. Our automated tools make this process seamless and non-intrusive."
                                },
                                {
                                    question: "Is the certification recognized internationally?",
                                    answer: "Yes, our standards align with major international frameworks including NIST 800-88, GDPR, HIPAA, and ISO 27001, making your certification valid and respected globally."
                                },
                                {
                                ...
                                <Reveal key={index} delayMs={index * 50}>
                                    <div className="bg-slate-50 rounded-2xl border border-slate-100 hover:border-emerald-200 transition-all duration-300 overflow-hidden">
                                        <button
                                            onClick={() => toggleFaq(index)}
                                            className="flex items-center justify-between w-full cursor-pointer p-4 text-left"
                                        >
                                            <h3 className={`text-lg font-bold transition-colors pr-4 ${openFaq === index ? 'text-emerald-600' : 'text-slate-900'}`}>
                                                {faq.question}
                                            </h3>
                                            <div className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 transition-all ${openFaq === index ? 'bg-emerald-500 rotate-180' : 'bg-slate-200'}`}>
                                                <svg className={`w-4 h-4 transition-colors ${openFaq === index ? 'text-white' : 'text-slate-600'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div className="flex">
                                                                <select
                                                                    ...
                                                                    onChange={handleChange}
                                                                    className="px-3 py-3 border border-slate-300 rounded-l-lg focus:border-emerald-600 focus:ring-1 focus:ring-emerald-600 outline-none transition-colors bg-white"
                                                                >
                                                                ...
                                                                <input
                                                                    ...
                                                                    onChange={handleChange}
                                                                    className="flex-1 px-4 py-3 border border-l-0 border-slate-300 rounded-r-lg focus:border-emerald-600 focus:ring-1 focus:ring-emerald-600 outline-none transition-colors"
                                    ...
                                    <div className="bg-white rounded-2xl shadow-lg border border-slate-200/60 p-6">
                                        ...
                                        <div className="space-y-3 text-sm">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <span className="text-slate-700">Response within 12 hours</span>
                                            </div>
                                            <div className="flex items-center gap-3">
                        ...
                        <Reveal>
                            <div className="max-w-4xl mx-auto text-center">
                                ...
                                <p className="text-lg text-slate-300 mb-10 max-w-2xl mx-auto">
                                    Join organizations worldwide that trust D-Secure for their data hygiene needs.
                                    Get your Assurance Badge and demonstrate your commitment to data security.
                                </p>
