                        ...
                        <Reveal>
                            <div className="text-center mb-10 sm:mb-16">
                                ...
                                <div className="max-w-2xl mx-auto">
                                    <div className="flex flex-col sm:flex-row gap-3 bg-white rounded-full p-2 shadow-xl">
                                        <input
                                            type="text"
                                            ...
                                            className="flex-1 px-6 py-3 bg-transparent border-none outline-none text-slate-700 placeholder-slate-400 rounded-full"
                                        />
                                        <button
                                            onClick={handleSearch}
                                            className="flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-semibold rounded-full hover:from-emerald-700 hover:to-teal-700 transition-all duration-300 shadow-lg hover:shadow-emerald-500/25"
                                        >
