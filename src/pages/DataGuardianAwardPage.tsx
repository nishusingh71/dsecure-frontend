              ...
              <Reveal>
                <div className="text-center mb-10 sm:mb-16">
                  ...
                  <p className="text-base sm:text-lg text-slate-600 max-w-3xl mx-auto">
                    Your gateway to a safe way to trade digital data. The
                    D-Secure Assurance Badge signifies that your organization
                    operates within a trusted ecosystem, enabling secure and
                    reliable data transactions with partners worldwide.
                  </p>
                </div>
              </Reveal>
              ...
              <Reveal>
                <div className="text-center mb-10 sm:mb-16">
                  ...
                  <p className="text-base sm:text-lg text-slate-600 max-w-3xl mx-auto">
                    ...
                    about implementing a complete data hygiene process that we
                    can audit and verify anytime.
                  </p>
                </div>
              </Reveal>
                  ...
                  <Reveal>
                    <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl border border-slate-200/60 p-5 sm:p-8 md:p-12">
                      ...
                      <p className="text-slate-600 text-center mb-6">
                        Get your organization certified with D-Secure Data
                        Hygiene Assurance
                      </p>
