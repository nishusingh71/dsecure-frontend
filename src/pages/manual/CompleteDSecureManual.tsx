...
//               <div>
//                 <p className="text-slate-700 mb-3"><strong>2.</strong>    <strong>  Select Files or Folders Manually: </strong> If you choose to browse manually, a "Select Files or Folders" window will appear. Navigate through your local directories (e.g., C:\D-Secure) to find the data you wish to remove. Select the desired file—such as "D-SecureErase.exe"—and click the "Add Selected" button to add it to the erasure queue. </p>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="text-slate-700 leading-relaxed">
          This is a web-based guide and requires an active internet connection. You can read this guide with all modern browsers including Chrome, Firefox, Edge, and Safari.
        </p>
      </>
    )
  },
    ...
    children: [
      {
        ...
        content: (
          <>
            ...
            <div className="space-y-6">
              <div>
                <p className="text-slate-700 leading-relaxed"><strong>1. Download the installer from the official DSecure website:</strong> Navigate to the official DSecure website using your preferred web browser. Locate the Downloads section and select the appropriate installer version compatible with your operating system (Windows, macOS, or Linux). Ensure you download from the official source to avoid any security risks or corrupted files. The installer file will be saved to your default Downloads folder.</p>
              </div>

              <div>
                <p className="text-slate-700 leading-relaxed"><strong>2. Run the installer with administrator privileges:</strong> Once the download is complete, navigate to your Downloads folder and locate the DSecure File Eraser installer file. Right-click on the installer executable and select "Run as Administrator" to ensure the installation process has the necessary permissions to install system-level components. This step is crucial for proper software integration with your operating system.</p>
              </div>
              ...
              <div>
                <p className="text-slate-700 leading-relaxed"><strong>4. Choose installation directory:</strong> The installer will prompt you to select a destination folder where DSecure File Eraser will be installed. You can either accept the default installation path (typically C:\Program Files\DSecure File Eraser on Windows) or click "Browse" to choose a custom location on your hard drive. Ensure the selected drive has sufficient free space for the installation, typically requiring at least 100-200 MB of available disk space.</p>
              </div>
        ...
        children: [
          {
            ...
            content: (
              <>
                <p className="text-slate-700 leading-relaxed mb-6">
                  On the left side of the bar, there are five main icons. Here is what each one does:
                </p>
                <div className="space-y-4 mb-8">
                  <div>
                    <p className="text-slate-700 leading-relaxed mb-2"><strong>First Icon (About):</strong> This displays the Product Information, including the software name, version details, and your system information.</p>
                  </div>
                  <div>
                    <p className="text-slate-700 leading-relaxed mb-2"><strong>Second Icon (Support):</strong> Clicking this will redirect you to the official Company Support Page for troubleshooting and assistance.</p>
                  </div>
                  <div>
                    <p className="text-slate-700 leading-relaxed mb-2"><strong>Third Icon (Update):</strong> Use this to check for and install the latest Software Updates to keep your program running smoothly.</p>
                  </div>
                  <div>
                    <p className="text-slate-700 leading-relaxed mb-2"><strong>Fourth Icon (Activation):</strong> This is used to Authorize your product. There are three ways to do this:</p>
                    <ul className="list-disc list-inside space-y-1 text-slate-700 ml-4 mb-2">
                      <li><strong>Cloud Activation:</strong> Log in with your ID and Password.</li>
                      <li><strong>Online Activation:</strong> Enter your unique Product Key.</li>
                      <li><strong>Offline Activation:</strong> Use a generated Hash Code for manual authorization.</li>
                    </ul>
                  </div>
                  <div>
                    <p className="text-slate-700 leading-relaxed mb-2"><strong>Fifth Icon (Help Manual):</strong> This redirects you to the company's Help Manual Page, where you can find detailed guides and documentation about the product.</p>
                  </div>
                </div>

                <h4 className="text-base font-semibold text-slate-800 mb-3">Shopping Cart Icon</h4>
                <p className="text-slate-700 leading-relaxed mb-6">
                  <strong>Right Corner Icon:</strong> This button takes you directly to the Product Purchase Page if you need to buy a license.
                </p>

                <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1770711271/joecdhp375m1kckg2ccz.png" alt="Menu Bar Icons" className="w-full mb-6" style={{ borderRadius: '3%' }} />

                {/* Old individual icon images - commented out
                <div className="space-y-4">
                  <div className="border border-slate-200 rounded overflow-hidden w-1/4">
                    <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1767179216/fsxo7fgdrpsmr9whozmm.jpg" alt="Main Dashboard" className="w-full h-auto" />
                  </div>
                  <div className="border border-slate-200 rounded overflow-hidden w-1/4">
                    <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1767179216/dqpwy8upofic1itdmcfe.jpg" alt="Erase Files Tab" className="w-full h-auto" />
      ...
      },
      {
        ...
        content: (
          <>
            <p className="text-slate-700 leading-relaxed mb-4">
              To know more about D-Secure File Eraser, click <Link to="/products" className="text-emerald-600 hover:underline">here</Link>.
            </p>
            <p className="text-slate-700 leading-relaxed mb-4">
              To purchase the software online, click <Link to="/pricing-and-plan?product=file-eraser" className="text-emerald-600 hover:underline">here</Link>.
            </p>
            <p className="text-slate-700 leading-relaxed mb-4">
              Alternatively, click on Buy Online icon on the Menu Bar to purchase the software online.
            </p>
      ...
      },
      {
        ...
        content: (
          <>
            <p className="text-slate-700 leading-relaxed mb-4">
              After purchasing D-Secure File Eraser, you need to activate the software using your license. There are three activation methods available:
            </p>
            <ol className="list-decimal list-inside space-y-4 text-slate-700 ml-4">
              <li className="mb-4">
                <span className="font-medium"><strong>Cloud Activation:</strong> Click the key icon in the top menu to open the Activation window. Select "Cloud Activation," enter your Email and Password, and click Login to verify your account status and activate the software.</span>
                <div className="mt-3 border-slate-200 rounded-lg overflow-hidden">
                  <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1770711427/xv6zlrgud13orikgk8oy.png" alt="Cloud Activation" className="w-full" style={{ borderRadius: '3%' }} />
                </div>
              </li>
              <li className="mb-4">
                <span className="font-medium"><strong>Online Activation:</strong> Select the "Online Activation" option and enter the product key received in your email into the text field. Click the "Activate" button to complete the process, or use "Get it Now" if you do not yet have a license key.</span>
                <div className="mt-3 border-slate-200 rounded-lg overflow-hidden">
                  <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1770711429/kvdpyqtupdnfpnublfl5.png" alt="Online Activation" className="w-full" style={{ borderRadius: '3%' }} />
                </div>
              </li>
              <li className="mb-4">
                <span className="font-medium"><strong>Offline Activation:</strong> Select the "Offline Activation" radio button to register without an active internet connection. Follow these steps:</span>
                <div className="space-y-4 mt-3 ml-4">
                  <div>
                    <p className="text-slate-700 mb-2"><strong>Step 1 — Generate Request Code:</strong> Click "Generate Request Code" to create a unique machine identifier. The code is automatically copied to your clipboard.</p>
                    <div className="border-slate-200 rounded-lg overflow-hidden">
                      <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1770713526/qt5rk7vm9yojpvgbefm9.jpg" alt="Generate Request Code" className="w-full" style={{ borderRadius: '3%' }} />
                    </div>
                  </div>
                  <div>
                    <p className="text-slate-700 mb-2"><strong>Step 2 — Share with Support:</strong> Share the generated code with the D-Secure Support Team to receive your Activation Response Code.</p>
                    <div className="border-slate-200 rounded-lg overflow-hidden">
                      <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1770711428/vlehmyvojl9heczeo7q9.png" alt="Share Code with Support" className="w-full" style={{ borderRadius: '3%' }} />
                    </div>
                  </div>
                  <div>
                    <p className="text-slate-700 mb-2"><strong>Step 3 — Enter Response Code:</strong> Once you receive the Activation Response Code from the support team, paste it into the response field and click "Activate" to complete the registration.</p>
                    <div className="border-slate-200 rounded-lg overflow-hidden">
                      <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1770712985/mndtq2nil2zkfkg2br4s.jpg" alt="Enter Response Code" className="w-full" style={{ borderRadius: '3%' }} />
                    </div>
                  </div>
                </div>
              </li>
    ...
    children: [
      {
        ...
        content: (
          <>
            <p className="text-slate-700 leading-relaxed mb-4">
              The Erase Files/Folders module allows you to permanently delete specific data from your system. Here is how it works:
            </p>
            <ul className="list-disc list-inside space-y-2 text-slate-700 ml-4 mb-6">
              <li><strong>Selecting Data:</strong> By clicking on the center area (the dashed box labeled "Click here to select Files or Folders for erasure"), a browse dialogue will open. You can use this to navigate through your computer's directories and select the files or folders you wish to delete.</li>
              <li><strong>Executing Erasure:</strong> Once you have selected your data, click the "Erase Now" button in the bottom right corner to start the secure deletion process.</li>
              <li><strong>Viewing Results:</strong> After the process is finished, a detailed report will be generated. You can view this report within the Report dialogue (accessible from the left sidebar) to confirm the successful erasure of your data.</li>
            </ul>
            <div className="space-y-6">
              <div>
                <p className="text-slate-700 mb-3"><strong>1.</strong>  <strong>  Access File Erasure Mode: </strong> Navigate to the "Erase Files/Folders" tab located in the left sidebar menu. The main interface will display a designated zone labeled "Drag & Drop Files & Folders Here". You can either drag your files directly into this area or click the "Browse Files" link to manually select data from your computer.</p>
                <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1770711365/hycoqj7ilc9ymzqlq79z.png" alt="Erase Files Tab" className="w-full mb-6" style={{ borderRadius: '4%' }} />
              </div>

              <div>
                <p className="text-slate-700 mb-3"><strong>2.</strong>    <strong>  Select Files or Folders Manually: </strong> If you choose to browse manually, a "Select Files or Folders" window will appear. Navigate through your local directories (e.g., C:\dsecure) to find the data you wish to remove. Select the desired file—such as "DSecureErase.exe"—and click the "Add Selected" button to add it to the erasure queue. </p>
                <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1770711365/je14zqp8p0bmu7gxlrqw.png" alt="Add Items" className="w-full mb-6" style={{ borderRadius: '1%' }} />
              </div>
              ...
              <div>
                <p className="text-slate-700 mb-3"><strong>4.</strong> <strong>  Initiate Erasure: </strong> Once you have verified your selection, click the "Erase Now" button located at the bottom right corner of the window. This action prepares the application to securely destroy the listed data. </p>
                <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1770714200/va6bffrful3q7adg8bej.png" alt="Erase Now" className="w-full mb-6" style={{ borderRadius: '4%' }} />
              </div>
              ...
              <div>
                <p className="text-slate-700 mb-3"><strong>6.</strong> <strong>  Erasure Process and Monitoring: </strong>D-SecureErase will now begin shredding the files. You can monitor the progress through the Shredder Animation and the Progress Bar. The interface also displays the real-time file path currently being processed. If necessary, you can halt the operation using the red "Stop" button. </p>
                <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1770714350/rqezftfhkucgzdffbypo.png" alt="Completion" className="w-full mb-6" style={{ borderRadius: '4%' }} />
              </div>
              ...
              <div>
                <p className="text-slate-700 mb-3"><strong>7.</strong> <strong>  Review File Erasure Summary: </strong>Upon completion, a "File's & Folder's Erasure Summary" report is generated. This table confirms the File Path, Size, and shows the final Status as "Erased & Verified". Click the "OK" button to close the summary and return to the main dashboard. </p>
                <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1770714434/ooibrjhnz388gpira13k.png" alt="Completion" className="w-full mb-6" style={{ borderRadius: '4%' }} />
              </div>
            </div>
      ...
      },
      {
        ...
        content: (
          <>
            <p className="text-slate-700 leading-relaxed mb-4">
              The Volume Eraser feature allows you to permanently and securely delete all data from a specific drive or partition.
            </p>

            <h4 className="text-base font-semibold text-slate-800 mb-3">How to Use:</h4>
            <ul className="list-disc list-inside space-y-2 text-slate-700 ml-4 mb-4">
              <li><strong>Select Volume:</strong> Choose the specific drive volume (e.g., OS or D:) that you wish to wipe from the available list.</li>
              <li><strong>Start Erasure:</strong> Click the "Erase Now" button to begin the permanent deletion process.</li>
            </ul>

            <h4 className="text-base font-semibold text-slate-800 mb-3">Security & Technical Process:</h4>
            <ul className="list-disc list-inside space-y-2 text-slate-700 ml-4 mb-4">
              <li><strong>Unmounting:</strong> For security reasons, the software will unmount the volume from the Operating System (OS) before starting.</li>
              <li><strong>Volume Locking:</strong> The selected volume is locked during the process to prevent any other applications from accessing it.</li>
              <li><strong>System Safety:</strong> Essential system files will remain safe even if a boot volume is selected.</li>
            </ul>

            <h4 className="text-base font-semibold text-slate-800 mb-3">Post-Erasure Requirement:</h4>
            <p className="text-slate-700 leading-relaxed mb-6">
              <strong>Reformatting for Reuse:</strong> Once the erasure process is complete, the volume will be in a raw state. To use the drive again for storing data, you must format the volume so it can be recognized and reused by the system.
            </p>
            <div className="space-y-6">
              <div>
                <p className="text-slate-700 mb-3"><strong>1.</strong> Select Target Volume</p>
                <p className="text-slate-600 text-sm mb-3">Click on the "Erase Volume" tab in the left sidebar to view all available drives. Check the box next to the specific volume you wish to wipe (e.g., C:\ or E:) and click the "Erase Now" button to proceed.</p>
                <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1767336045/um6ckm7shkbv9s22af2b.jpg" alt="Select Target Volume" className="w-full mb-6" style={{ borderRadius: '3%' }} />
              </div>

              <div>
                <p className="text-slate-700 mb-3"><strong>2.</strong> Handling Locked Volumes</p>
                <p className="text-slate-600 text-sm mb-3">If a drive appears as "Locked / Inaccessible" (e.g., F:\ [Locked]), it cannot be selected for erasure in its current state. Ensure the drive is properly connected and unlocked before attempting to check the selection box for wiping.</p>
                <img src=" https://res.cloudinary.com/dhwi5wevf/image/upload/v1767336045/fpfrmbqwqikle2twmuj5.jpg" alt="Handling Locked Volumes" className="w-full mb-6" style={{ borderRadius: '3%' }} />
              </div>

              <div>
                <p className="text-slate-700 mb-3"><strong>3.</strong> Confirm Erasure</p>
                <p className="text-slate-600 text-sm mb-3">Once you click "Erase Now," a Confirm Erasure dialog box will appear listing the selected drive (e.g., F:). This action is permanent and cannot be undone; click "Yes, Erase" to proceed with the wiping process or "Cancel" to go back.</p>
                <img src=" https://res.cloudinary.com/dhwi5wevf/image/upload/v1767336045/r3zhjmt6nlhflpxlscm4.jpg  " alt="Confirm Erasure" className="w-full mb-6" style={{ borderRadius: '3%' }} />
              </div>

              <div>
                <p className="text-slate-700 mb-3"><strong>4.</strong> Permanently Wipe Selected Volume</p>
                <p className="text-slate-600 text-sm mb-3">Confirm the erasure by clicking "Yes, Erase" in the dialog box. This will trigger the wiping process for the selected drive (e.g., F:), permanently removing all stored data to ensure it cannot be recovered.</p>
                <img src="  https://res.cloudinary.com/dhwi5wevf/image/upload/v1767336046/skf0os0bjcx36lon0lsl.jpg" alt="Permanently Wipe Volume" className="w-full mb-6" style={{ borderRadius: '3%' }} />
              </div>

              <div>
                <p className="text-slate-700 mb-3"><strong>5.</strong> Monitor Erasure Progress</p>
                <p className="text-slate-600 text-sm mb-3">After confirming, the software begins wiping the drive sector by sector. You can track the real-time progress through the percentage bar and the exact sector count being processed (e.g., 20,701,184 sectors). A "Stop" button is available if you need to terminate the process immediately.</p>
                <img src=" https://res.cloudinary.com/dhwi5wevf/image/upload/v1767336045/m7zxxdttloczazi01n9k.jpg  " alt="Monitor Erasure Progress" className="w-full mb-6" style={{ borderRadius: '3%' }} />
              </div>

              <div>
                <p className="text-slate-700 mb-3"><strong>6.</strong> Finalizing Erasure</p>
                <p className="text-slate-600 text-sm mb-3">As the process nears completion, the progress bar will reach approximately 88.9%, showing that the vast majority of sectors (e.g., 96,960,512) have been successfully wiped. Keep the software running until the bar reaches 100% to ensure every sector of the selected volume is permanently erased.</p>
                <img src=" https://res.cloudinary.com/dhwi5wevf/image/upload/v1767336045/ignz55qmsntaodg2ecm1.jpg  " alt="Finalizing Erasure" className="w-full mb-6" style={{ borderRadius: '3%' }} />
              </div>

              <div>
                <p className="text-slate-700 mb-3"><strong>7.</strong> Completion Notification</p>
                <p className="text-slate-600 text-sm mb-3">Once the process reaches 100%, a Volume Erasure information box will appear confirming that the "Volume erased successfully". Click the "OK" button to close the dialog and return to the main menu.</p>
                <img src=" https://res.cloudinary.com/dhwi5wevf/image/upload/v1767336047/xrqzkfrixory2xgri0p5.jpg " alt="Completion Notification" className="w-full mb-6" style={{ borderRadius: '3%' }} />
              </div>

              <div>
                <p className="text-slate-700 mb-3"><strong>8.</strong> View Erasure Summary</p>
                <p className="text-slate-600 text-sm mb-3">After clicking "OK" on the success dialog, a Summary table will appear. This table provides a final log of the operation, including the Target drive (F:), its Capacity (52.00 GB), the total Sectors Erased (109,043,712), and the Method used. Click the blue "OK" button at the bottom right to return to the volume selection screen.</p>
                <img src=" https://res.cloudinary.com/dhwi5wevf/image/upload/v1767336046/ga10g9ac9maloluzooih.jpg " alt="View Erasure Summary" className="w-full mb-6" style={{ borderRadius: '3%' }} />
              </div>

              <div>
                <p className="text-slate-700 mb-3"><strong>9.</strong> Drive Reformatting</p>
                <p className="text-slate-600 text-sm mb-3">After the volume erasure is complete, the drive will appear as unallocated or unrecognized by the system. To make it usable again, right-click the drive in your file explorer and select "Format..." to create a new file system and restore its accessibility.</p>
                <img src=" https://res.cloudinary.com/dhwi5wevf/image/upload/v1767336046/gngbhft33b34tgppfsx7.jpg " alt="Drive Reformatting" className="w-full mb-6" style={{ borderRadius: '3%' }} />
              </div>

              <div>
                <p className="text-slate-700 mb-3"><strong>10.</strong> Format Volume for Re-use</p>
                <p className="text-slate-600 text-sm mb-3">To make the erased drive accessible again, open Windows File Explorer, right-click the wiped volume (e.g., F:), and select "Format...". In the format window, ensure "Quick Format" is selected and click "Start" to restore the drive's file system for normal use.</p>
                <img src=" https://res.cloudinary.com/dhwi5wevf/image/upload/v1767336047/c5xgql17tc8qsgrjl3eh.jpg  " alt="Format Volume" className="w-full mb-6" style={{ borderRadius: '3%' }} />
              </div>

              <div>
                <p className="text-slate-700 mb-3"><strong>11.</strong> Formatting Complete</p>
                <p className="text-slate-600 text-sm mb-3">Once the quick format is finished, a notification will appear stating "Format Complete". Click the "OK" button to finalize the process; your drive is now fully restored with a clean file system and ready for new data.</p>
                <img src=" https://res.cloudinary.com/dhwi5wevf/image/upload/v1767336047/yncpgejwjilmbeq1wx7f.jpg " alt="Formatting Complete" className="w-full mb-6" style={{ borderRadius: '3%' }} />
              </div>
            </div>
          </>
        )
      },
      {
        ...
        content: (
          <>
            <p className="text-slate-700 leading-relaxed mb-4">
              The Erase Cloud Storage feature allows you to securely delete data from your connected cloud accounts.
            </p>

            <h4 className="text-base font-semibold text-slate-800 mb-3">Cloud Connection</h4>
            <ul className="list-disc list-inside space-y-2 text-slate-700 ml-4 mb-4">
              <li><strong>Cloud Service:</strong> Currently, the software specifically supports Google Drive for cloud erasure.</li>
              <li><strong>Stable Connection:</strong> It is important to ensure your internet connection remains active throughout the entire erasure process to avoid errors.</li>
              <li><strong>Getting Started:</strong> Select your service from the dropdown menu and click the "Connect" button to link your account.</li>
            </ul>

            <h4 className="text-base font-semibold text-slate-800 mb-3">Available Erasure Options</h4>
            <p className="text-slate-700 leading-relaxed mb-2">
              Once connected, you can perform the same high-level security tasks on your cloud storage as you do on your local machine:
            </p>
            <ul className="list-disc list-inside space-y-2 text-slate-700 ml-4 mb-6">
              <li><strong>Files and Folders:</strong> Select specific documents or directories from your Google Drive to be permanently deleted.</li>
              <li><strong>Volume Erasure:</strong> Securely wipe entire cloud storage volumes.</li>
              <li><strong>Deleted Data:</strong> Clean up fragments of previously deleted cloud data to ensure they are unrecoverable.</li>
            </ul>
            <div className="space-y-6">
              <div>
                <p className="text-slate-700 mb-3"><strong>1.</strong> Select 'Cloud Storage' tab</p>
                <p className="text-slate-600 text-sm mb-3 italic">Note: You must be logged into your Google account for this feature to work.</p>
                <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1770711410/lnt8socy5ivaaopgdnh5.png" alt="Cloud Storage Interface" className="w-full mb-6" style={{ borderRadius: '3%' }} />
              </div>
              ...
              <div>
                <p className="text-slate-700 mb-3"><strong>6.</strong> Erase Cloud Volume</p>
                <p className="text-slate-600 text-sm mb-3">Select the "Erase Volume" radio button to wipe the entire contents of your cloud storage. The interface will display a "Google Drive - Storage Overview" card showing your current usage statistics (e.g., 18% used, 12.25 GB free). Check the box located on this storage card to select the volume for erasure.</p>
                <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1767113788/u1u6v9rli9sea3sij9ya.jpg" alt="Erase Cloud Volume" className="w-full mb-6" style={{ borderRadius: '3%' }} />
              </div>

              <div>
                <p className="text-slate-700 mb-3"><strong>7.</strong> Select Erase Files/Folder Option</p>
                <p className="text-slate-600 text-sm mb-3">Select the "Erase Files/Folder" radio button to view your cloud directory structure. A file tree will appear showing your Google Drive folders (e.g., "Testing Data"). Expand the folders and check the boxes next to the specific files or subfolders you wish to permanently remove.</p>
                <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1767113786/oiqnosbnioa1dasr8a6a.jpg" alt="Select Erase Files Folder" className="w-full mb-6" style={{ borderRadius: '3%' }} />
              </div>

              <div>
                <p className="text-slate-700 mb-3"><strong>8.</strong> Browse File Directory</p>
                <p className="text-slate-600 text-sm mb-3">Alternatively, select the "Erase Files/Folder" radio button to access individual files instead of wiping the whole volume. The interface will load your cloud directory structure, showing the root folder (e.g., "Google Drive") and subfolders like "Testing Data (1)". This view allows you to navigate through your storage hierarchy to pinpoint specific data for removal.</p>
                <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1767113794/utipneibbd6y7rxsbqdh.jpg" alt="Browse File Directory" className="w-full mb-6" style={{ borderRadius: '3%' }} />
              </div>

              <div>
                <p className="text-slate-700 mb-3"><strong>9.</strong> Erase Specific Files and Folders</p>
                <p className="text-slate-600 text-sm mb-3">Select the "Erase Files/Folder" radio button to browse your cloud directory structure. A hierarchical file tree will appear, displaying your Google Drive folders and files (e.g., "Testing Data", "erase data - Copy"). Expand the directories and check the boxes next to the specific items you want to permanently erase.</p>
                <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1767113792/lfli5ca1ij5xi5fopgwp.jpg" alt="Erase Specific Files" className="w-full mb-6" style={{ borderRadius: '3%' }} />
              </div>

              <div>
                <p className="text-slate-700 mb-3"><strong>10.</strong> Select Items to Erase</p>
                <p className="text-slate-600 text-sm mb-3">Navigate deeper into the directory tree to locate the specific data you intend to destroy. Click the checkboxes next to the individual files (such as .tmp or media files) or entire sub-folders to mark them for deletion. Ensure that the checkboxes are ticked for all items you wish to permanently remove before proceeding.</p>
                <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1767113790/jdxortfirlhfvosmh8x2.jpg" alt="Select Items to Erase" className="w-full mb-6" style={{ borderRadius: '3%' }} />
              </div>

              <div>
                <p className="text-slate-700 mb-3"><strong>11.</strong> Confirm and Execute Erasure</p>
                <p className="text-slate-600 text-sm mb-3">After making your selection, click the "Erase Cloud Data" button. A "Confirm Cloud Erasure" dialog box will appear, displaying a summary of the items to be deleted (e.g., "3 files and 1 folders"). The dialog includes a warning that "This action cannot be undone". Click the "Yes, Erase" button to proceed with the permanent deletion of the selected cloud data.</p>
                <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1767113932/slpruaiyeqwipbc4rrnj.jpg" alt="Confirm Cloud Erasure" className="w-full mb-6" style={{ borderRadius: '3%' }} />
              </div>

              <div>
                <p className="text-slate-700 mb-3"><strong>12.</strong> Erasure in Progress</p>
                <p className="text-slate-600 text-sm mb-3">Once confirmed, the application begins the secure erasure process. The interface displays a large shredding animation along with a progress bar and status message (e.g., "Starting cloud erasure...") to keep you informed. If you need to halt the operation immediately, you can click the "Stop" button located at the bottom right of the window.</p>
                <img src=" https://res.cloudinary.com/dhwi5wevf/image/upload/v1767113930/qixab9dmayc9j8gif6gh.jpg" alt="Erasure in Progress" className="w-full mb-6" style={{ borderRadius: '3%' }} />
              </div>

              <div>
                <p className="text-slate-700 mb-3"><strong>13.</strong> Monitor Real-Time Progress</p>
                <p className="text-slate-600 text-sm mb-3">As the operation advances, the progress bar updates to reflect the percentage of completion (e.g., 33%). The status message below the bar provides specific details about the current action, identifying which file is currently being destroyed (e.g., "Erasing cloud file 1/3: deleted_..."). This allows you to track exactly which data is being processed in real-time.</p>
                <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1767113794/hjxm0vunlo5dgegixnyd.jpg" alt="Monitor Real-Time Progress" className="w-full mb-6" style={{ borderRadius: '3%' }} />
              </div>

              <div>
                <p className="text-slate-700 mb-3"><strong>14.</strong> Review Erasure Summary</p>
                <p className="text-slate-600 text-sm mb-3">When the process completes, the application presents a "Cloud File Erasure Summary" table. This report details the specific files that were processed, showing their full file paths (e.g., ".../erase data - Copy (1)"), file sizes (e.g., 103.09 MB), and their final status as "Erased". Review the details and click the "OK" button to close the summary and finish the operation.</p>
                <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1767113794/j1ieckpw4d9gbgphwhue.jpg" alt="Review Erasure Summary" className="w-full mb-6" style={{ borderRadius: '3%' }} />
              </div>

              <div className="bg-emerald-50 border-l-4 border-emerald-500 p-4 mt-6">
                <p className="text-emerald-900 font-semibold mb-2">Important Notes:</p>
      ...
      },
      {
        ...
        content: (
          <>
            <p className="text-slate-700 leading-relaxed mb-4">
              The Scheduler allows you to automate your data erasure tasks so they run automatically at a time that suits you.
            </p>

            <h4 className="text-base font-semibold text-slate-800 mb-3">Overview</h4>
            <ul className="list-disc list-inside space-y-2 text-slate-700 ml-4 mb-6">
              <li><strong>Setting the Frequency:</strong> Choose how often the task should run — Once, Daily, Weekly, Monthly, or Every Boot. You can also select the specific Date and Time for the process to start.</li>
              <li><strong>Creating a New Task:</strong> Give your task a name, click Browse to select files or folders, and click OK to save and activate the schedule.</li>
              <li><strong>Managing Existing Tasks:</strong> View, edit, or delete tasks you have already set up.</li>
              <li><strong>Post-Process Reporting:</strong> Once a scheduled cleaning process is complete, a detailed report is automatically generated and saved for review.</li>
            </ul>
            <div>
              <p className="text-slate-700 mb-3"><strong>1.</strong> <strong>    Open Scheduler Tab    </strong>  Click on the "Scheduler" icon in the left sidebar to access the configuration screen for automated tasks. This section allows you to create new schedules or manage existing ones to ensure your data is wiped at specific intervals.      </p>
              <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1770711317/bxrtjrazdykaigxpstvh.png" alt="Cloud Storage Interface" className="w-full mb-6" style={{ borderRadius: '3%' }} />
            ...
            <div>
              <p className="text-slate-700 mb-3"><strong>2.</strong> <strong>   Configure Task Details     </strong> Define the parameters for your automated erasure:
                ...
                <h5><strong>2.3 Select Data: </strong>Click "Browse" to choose the files or folders you want to schedule for permanent deletion.   </h5>   </p>
              <br />
              <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1770715325/laotgyzqllfyxekxjac3.png" alt="Cloud Storage Interface" className="w-full mb-6" style={{ borderRadius: '3%' }} />

            </div>
            <div>
              <p className="text-slate-700 mb-3"><strong>3.</strong> <strong>  Browse and Select Items      </strong>  Click the "Browse" button to open a file selection window. Navigate through your local directories (e.g., F:\Testing Data) and check the boxes next to the specific folders or files you wish to add to the schedule. Click the "Add" button to include these items in your task list.     </p>

              <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1770715416/i3a0wyokj9cvgb5ot3rx.png" alt="Cloud Storage Interface" className="w-full mb-6" style={{ borderRadius: '3%' }} />

            </div>
            <div>
              <p className="text-slate-700 mb-3"><strong>4.</strong> <strong> Finalize and Save Task       </strong>   Once you have added the items from the browse window, they will appear in the task list showing the Name, Size, and Type. Review the details and click the "OK" button at the bottom right to save and activate your scheduled erasure task.    </p>

              <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1770715599/l3vdax5xrlws4gkezm3g.png" alt="Cloud Storage Interface" className="w-full mb-6" style={{ borderRadius: '3%' }} />

            </div>
            <div>
              <p className="text-slate-700 mb-3"><strong>5.</strong> <strong>Confirm and Save Schedule:</strong> Review your finalized task in the list to ensure the correct Name, Size, and Type (e.g., Folder) are displayed. Click the "OK" button to activate the schedule. An "Info" dialog box will appear confirming, "Task 'ERASEFILES' scheduled successfully". Click "OK" on the dialog box to finish the setup.</p>

              <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1770715743/kx1kbcagwuqcr32hbno7.png" alt="Confirm Schedule" className="w-full mb-6" style={{ borderRadius: '3%' }} />

            </div>
            <div>
              <p className="text-slate-700 mb-3"><strong>6.</strong> <strong>Manage Existing Tasks:</strong> To view or modify your schedules, select the "Existing Task" radio button within the Scheduler interface. This will display a table of all current tasks, including the Task Name, Trigger time, and Frequency. From this view, you can select a specific task (e.g., "ERASEFILES") and use the "Edit" or "Delete" buttons to manage your automated erasure library.</p>

              <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1770715970/npdrnfx41ol1ydjcpmvh.png" alt="Cloud Storage Interface" className="w-full mb-6" style={{ borderRadius: '3%' }} />

            </div>
            <div>
              <p className="text-slate-700 mb-3"><strong>7.</strong> <strong>Edit an Existing Task:</strong> To modify a scheduled operation, select a task from the list and click the "Edit" button. An "Edit Task" window will appear, allowing you to update the Frequency, Start From date and time, or add/remove items using the Browse button. Once your changes are complete, click "Save" to update the automated task.</p>

              <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1770715842/oqyug297bvixjec1ftw2.png" alt="Edit Existing Task" className="w-full mb-6" style={{ borderRadius: '3%' }} />

            </div>
            <div>
              <p className="text-slate-700 mb-3"><strong>8.</strong> <strong>Update Task and Confirm:</strong> After modifying the necessary details in the Edit Task window, click the "Save" button to apply the changes. An "Info" dialog box will appear to confirm that the task (e.g., 'ERASEFILES') has been updated successfully. Click "OK" on the dialog box to return to the main scheduler view.</p>

              <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1770716112/knmwcmszhxv7cerwail0.png" alt="Update Task Confirmation" className="w-full mb-6" style={{ borderRadius: '3%' }} />

            </div>
            <div>
              <p className="text-slate-700 mb-3"><strong>9.</strong> <strong>Monitor Scheduled Execution:</strong> When a scheduled task reaches its set time, a dedicated Scheduler progress window will automatically appear. This window allows you to track the erasure in real-time, showing the percentage completed, files being processed, and elapsed time.</p>


              <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1770711316/d8zjnvm0ab0daf6agysm.png" alt="Cloud Storage Interface" className="w-full mb-6" style={{ borderRadius: '3%' }} />

            </div>


            <div>
              <p className="text-slate-700 mb-3"><strong>10.</strong> <strong>Final Completion and Report Generation:</strong> When the task finishes, the progress bar will reach 100%, and the interface will display a green checkmark indicating "Scheduled erasure completed!". The system will also confirm the total number of items processed (e.g., "All 58 files erased") and state that a "Report generated successfully". You can now safely close the scheduler window.</p>
        ...
        children: [
          {
            ...
            content: (
              <>
                <p className="text-slate-700 leading-relaxed mb-4">
                  The Reports section provides a complete log of every erasure operation performed by the software. Here is what you can do:
                </p>
                <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1770727626/1fcf4411-a313-4ef2-9d79-4a0566411afb.png" alt="Reports Interface" className="w-full mb-6" style={{ borderRadius: '3%' }} />
                <ul className="list-disc list-inside space-y-2 text-slate-700 ml-4 mb-6">
                  <li><strong>Viewing and Filtering:</strong> Access and browse through your history of completed erasure tasks. You can filter reports by date, type, or status.</li>
                                      <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1770728043/7c884283-c92a-426c-946f-e8286e96a7f6.png" alt="Reports Interface" className="w-full my-4" style={{ borderRadius: '3%' }} />
                  <li><strong>Managing Reports:</strong> Preview any report's details, save it locally in PDF format, or securely upload it to your DSecure Cloud account for centralized storage.
                    <br />



                  </li>
                  <li><strong>Settings and Customization:</strong> Configure reports with your company branding — including your company name, logo, and technician information — for professional documentation.
                    <br />
                    <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1770728165/432a9300-2264-40e1-b7ef-755ab0f5c0bc.png" alt="Reports Interface" className="w-full my-4" style={{ borderRadius: '3%' }} />
                  </li>
                </ul>
                <div className="space-y-6">
                  <div>
                  ...
                  <div>
                    <p className="text-slate-700 leading-relaxed"><strong>6. Close or Proceed:</strong> After reviewing the report, you can either close the preview window if you need to make changes to report settings, or proceed directly to save the report or send it to DSecure Cloud using the action buttons provided in the preview window.</p>
                  </div>
                </div>
              </>
            )
          },
          {
            ...
            content: (
              <>
                <p className="text-slate-700 leading-relaxed mb-6">
                  Saving erasure reports creates tamper-proof documentation of all data deletion operations. Saved reports can be used for compliance audits, regulatory requirements, and organizational record-keeping.
                </p>

                <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1770729648/ce41a1aa-9b7e-4501-9464-1acc257491d0.png" alt="Reports Interface" className="w-full my-4" style={{ borderRadius: '3%' }} />
                <div className="space-y-6">
                  <div>
                    <p className="text-slate-700 leading-relaxed"><strong>1. Select Report from Reports Tab:</strong> Open the Reports section from the main navigation menu. The interface displays all generated reports in a comprehensive list view. Locate the specific report you wish to save by browsing the list or using the search functionality to filter by date or erasure type.</p>
                  </div>
          ...
          },
          {
            ...
            content: (
              <>
                <p className="text-slate-700 leading-relaxed mb-6">
                  D-Secure Cloud provides secure, encrypted cloud storage for your erasure reports. This enables remote access from any device, centralized management of all your reports, and automatic synchronization across multiple installations.
                </p>
               <img src=" https://res.cloudinary.com/dhwi5wevf/image/upload/v1770730165/03a33448-7ef7-4e9b-837e-c7617d81916f.png" alt="Reports Interface" className="w-full my-4" style={{ borderRadius: '3%' }} />

                <div className="space-y-6">
                  <div>
                    <p className="text-slate-700 leading-relaxed"><strong>1. Verify Cloud Account Login:</strong> Before uploading reports, ensure you are logged into your DSecure Cloud account. Check the cloud status indicator in the top right corner of the application. If not logged in, click on the cloud icon and enter your DSecure Cloud credentials (email and password) to authenticate.</p>
                  </div>
                  ...
                  <div>
                    <p className="text-slate-700 leading-relaxed"><strong>3. Select Reports for Upload:</strong> Review the list and select one or more reports you wish to send to DSecure Cloud by checking the boxes next to each report entry. You can select multiple reports simultaneously for batch upload. Reports already synchronized with cloud will be indicated with a special marker.</p>
                  </div>

                  <div>
                    <p className="text-slate-700 leading-relaxed"><strong>4. Initiate Cloud Upload:</strong> With your reports selected, click the "Send to Cloud" button located in the toolbar at the top of the reports interface. This will prepare the selected reports for secure upload to your DSecure Cloud account.</p>
                  </div>
                  ...
                  <div>
                    <p className="text-slate-700 leading-relaxed"><strong>6. Monitor Upload Progress:</strong> A progress indicator displays the upload status for each report, showing percentage completed and estimated time remaining. Once upload is complete, a success notification appears, and the reports are marked as synchronized. You can now access these reports from any device by logging into your DSecure Cloud Console.</p>
                  </div>
                </div>
              </>
            )
          },
          {
            ...
            content: (
              <>
                <p className="text-slate-700 leading-relaxed mb-6">
                  Report Settings allow you to customize the appearance and content of your erasure reports. You can add your organization's branding, configure technician details, and choose which data fields appear in the final report to match your documentation standards.
                </p>

                 <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1770730237/3b0cf677-94a0-4bbe-8a80-8bc495a94d51.png" alt="Reports Interface" className="w-full my-4" style={{ borderRadius: '3%' }} />
                <div className="space-y-6">
                  <div>
                    <p className="text-slate-700 leading-relaxed"><strong>1. Access Settings Menu:</strong> Click on the Settings icon (gear/cog icon) located in the top navigation bar or main menu. This opens the comprehensive settings panel where you can configure various aspects of the application's behavior and appearance.</p>
                  </div>
            ...
            children: [
              {
                ...
                content: (
                  <>
                    <p className="text-slate-700 leading-relaxed mb-4">
                      The Settings window is divided into two main tabs: <strong>General Settings</strong> and <strong>Ignore List</strong>.
                    </p>

                     <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1770730237/3b0cf677-94a0-4bbe-8a80-8bc495a94d51.png" alt="Reports Interface" className="w-full my-4" style={{ borderRadius: '3%' }} />

                    <h4 className="text-base font-semibold text-slate-800 mb-3">General Settings</h4>
                    <p className="text-slate-700 leading-relaxed mb-4">
                      The General Settings tab contains four key areas:
                    </p>
                    <ul className="list-disc list-inside space-y-3 text-slate-700 ml-4 mb-6">
                      <li><strong>Appearance:</strong> Choose between Light Mode, Dark Mode, or System Default to customize the application's visual theme for your comfort.</li>
                      <li><strong>Eraser Method:</strong> Select your default data erasure algorithm (e.g., DoD 5220.22-M, Gutmann, NIST 800-88). Higher-pass algorithms provide greater security but take more time.</li>
                      <li><strong>Verification:</strong> Set whether the software should verify each erasure operation. Options include None, Quick Verification, or Full Verification.</li>
                      <li><strong>Actions:</strong> Configure what happens after erasure completes — such as auto-generating reports, showing confirmation dialogs, or playing sound notifications.</li>
                    </ul>

                    <h4 className="text-base font-semibold text-slate-800 mb-3">Ignore List</h4>
                    <p className="text-slate-700 leading-relaxed mb-4">
                      The Ignore List tab allows you to specify files, folders, or file types that should be excluded from all erasure operations. This is useful for protecting important files from accidental deletion.
                    </p>
                    <ul className="list-disc list-inside space-y-2 text-slate-700 ml-4">
                      <li>Click "Add" to browse and select items to protect.</li>
                      <li>Use "Remove" to take items off the ignore list.</li>
                      <li>Items on this list will be automatically skipped during any erasure process.</li>
                    </ul>
                  </>
                )
              },
              {
                ...
                content: (
                  <>
                    <p className="text-slate-700 leading-relaxed mb-4">
                      The Erasure Options section allows you to configure the default algorithm and verification method used by the software.
                    </p>

                     <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1770730838/e5500381-d52f-4d34-aa79-b93cff886c59.png" alt="Reports Interface" className="w-full my-4" style={{ borderRadius: '3%' }} />
                    <div className="space-y-6">
                      <div>
                        <p className="text-slate-700 leading-relaxed"><strong>Default Algorithm:</strong> Select your preferred erasure standard from 20+ internationally recognized algorithms. Common options include DoD 5220.22-M (3-pass), DoD 5220.22-M ECE (7-pass), Gutmann (35-pass), and NIST 800-88. Higher pass counts provide greater security but require more time.</p>
                      </div>

                      <div>
                        <p className="text-slate-700 leading-relaxed"><strong>Verification Method:</strong> Choose how the software confirms successful erasure. "Quick Verification" spot-checks random sectors, "Full Verification" checks all erased sectors, and "No Verification" skips the check for faster processing. Full verification is recommended for sensitive data.</p>
                      </div>

                      <div>
                        <p className="text-slate-700 leading-relaxed"><strong>Additional Preferences:</strong> Configure options such as "Delete files after erasure," "Show confirmation dialogs," "Enable sound notifications," and "Generate automatic reports" to customize your workflow.</p>
                      </div>

                      <div>
                        <p className="text-slate-700 leading-relaxed"><strong>Save Settings:</strong> Click "Save Settings" or "Apply" at the bottom of the panel to apply your configuration. These settings will be used as defaults for all future erasure operations.</p>
                      </div>
                    </div>
                  </>
                )
          ...
          <>
            ...
            <div className="space-y-6">
              <div>
                <p className="text-slate-700 leading-relaxed mb-3"> Access Activation Window Click the key icon in the top toolbar to open the Activation dialog. Select the "Cloud Activation" radio button to use your registered account</p>
                <div className=" border-gray-200 rounded-lg overflow-hidden">
                  <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1770711271/joecdhp375m1kckg2ccz.png" alt="Cloud Login Access" className="w-full" style={{ borderRadius: '3%' }} />
                </div>
              </div>
              ...
              <div>
                <p className="text-slate-700 leading-relaxed mb-3">Enter Credentials Enter your registered Email and Password in the provided text fields. The Status field will show "Disconnected" until you successfully log in.</p>
                <div className=" border-gray-200 rounded-lg overflow-hidden">
                  {/* <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1770711427/xv6zlrgud13orikgk8oy.png" alt="Enter Cloud Credentials" className="w-full" style={{ borderRadius: '3%' }} /> */}
                </div>
              </div>
              ...
              <div>
                <p className="text-slate-700 leading-relaxed mb-3">Complete Login Click the "Login" button to verify your credentials and activate the software via the cloud.</p>
                <div className=" border-gray-200 rounded-lg overflow-hidden">
                  <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1770711427/xv6zlrgud13orikgk8oy.png" alt="Account Verification" className="w-full" style={{ borderRadius: '3%' }} />
                </div>
              </div>
              ...
              <div>
                <p className="text-slate-700 leading-relaxed mb-3">Generate Offline Request If you choose "Offline Activation," click the "Generate Request Code" button to create a unique machine identifier. A pop-up will confirm that the code has been generated and automatically copied to your clipboard.</p>
                <div className=" border-gray-200 rounded-lg overflow-hidden">
                  {/* <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1767190293/krkocraxnwan7eniscsh.jpg" alt="Cloud Connection" className="w-full" style={{ borderRadius: '3%' }} /> */}
                </div>
              </div>
              ...
              <div>
                <p className="text-slate-700 leading-relaxed mb-3">Submit and Activate Share the generated code with the D-Secure Support Team to receive your Activation Response Code. Once received, paste it into the response field and click the "Activate" button to complete the registration without an internet connection.</p>
                <div className=" border-gray-200 rounded-lg overflow-hidden">
                  <img src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1770712985/mndtq2nil2zkfkg2br4s.jpg" alt="Cloud Features Active" className="w-full" style={{ borderRadius: '3%' }} />
                </div>
              </div>
            </div>
          </>
    ...
    content: (
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-slate-700">Yes, you can erase specific files by adding them to the erasure list or dragging the items and dropping them in the software or you can also erase selected files through <span className="text-emerald-600 font-medium">Search & Erase</span> option.<br /><br />For more information, refer to <span className="text-emerald-600 font-medium">Erase Files and Folders</span> section.</p>
        </div>
        ...
        <div>
          <h3 className="text-lg font-bold text-slate-800 mb-2">9. Which algorithm should I choose for the best erasure?</h3>
          <p className="text-slate-700">It depends upon how many times an algorithm overwrites the data precisely or the number of passes used to erase the data. The more the number of passes used by the algorithm, more effective it is. Each algorithm performs a different set of features from which you can choose the suitable algorithm as per the requirement. See <span className="text-emerald-600 font-medium">List of Erasure Algorithms and their Descriptions</span>, to know more.</p>
        </div>
        ...
        <div>
          <h3 className="text-lg font-bold text-slate-800 mb-2">13. Is it possible to erase specific internet activities instead of clearing all of them?</h3>
          <p className="text-slate-700">Yes, you can choose specific items or internet activities from the list of browsers you want to erase. See <span className="text-emerald-600 font-medium">Erase Internet Traces</span>, to know more.</p>
        </div>

        <div>
          <h3 className="text-lg font-bold text-slate-800 mb-2">14. What if I lose or misplace erasure reports on my system, what can I do?</h3>
          <p className="text-slate-700">The application provides functionality to send erasure reports to Cloud so it could be secured even when not in use. See <span className="text-emerald-600 font-medium">Send Report to DSecure Cloud</span> to know more.</p>
        </div>

        <div>
          <h3 className="text-lg font-bold text-slate-800 mb-2">15. Can I preview and save the erasure reports?</h3>
          <p className="text-slate-700">Yes, you can do it. Refer to <span className="text-emerald-600 font-medium">Preview</span> and <span className="text-emerald-600 font-medium">Save</span> section to know more.</p>
        </div>

        <div>
          <h3 className="text-lg font-bold text-slate-800 mb-2">16. Can I get the reports of the data I have deleted so far?</h3>
          <p className="text-slate-700">Yes, <strong>DSecure File Eraser</strong> provides erasure reports. See <span className="text-emerald-600 font-medium">Reports</span> for more details.</p>
        </div>
        ...
        <div>
          ...
          <p className="text-slate-700">Yes, it is secure to use <strong>DSecure File Eraser</strong> to erase data in the <span className="text-emerald-600 font-medium">free space</span> of the hard drive's primary partition as it removes the free space left after deletion of files and folders.</p>
        </div>
        ...
        <div>
          ...
          <p className="text-slate-700 mt-2">Once you have scheduled the erase traces task for the particular browser, it will run automatically at the designated time and date, erasing all the traces of your browsing history, cookies, and related data.<br />To know more, please refer to <span className="text-emerald-600 font-medium">Set Schedule Erasure for Erase Traces</span> section.</p>
        </div>

        <div>
          <h3 className="text-lg font-bold text-slate-800 mb-2">19. Is it possible for the software to automatically erase traces of any files or folder?</h3>
          <p className="text-slate-700">Yes, <strong>DSecure File Eraser</strong> provides an option to schedule eraser task to perform automatically at predefined period. Refer to <span className="text-emerald-600 font-medium">Set Schedule Erasure for Files and Folders</span> section to schedule erasure task automatically.</p>
        </div>
      </div>
    )
  },
...
const SidebarItem: React.FC<{ item: NavItem; activeSection: string; onJump: (id: string) => void; level?: number }> = ({ item, activeSection, onJump, level = 0 }) => {
  ...
  return (
    <div className="text-sm">
      ...
      <div className={`flex items-center gap-2 py-1.5 px-3 rounded-md transition-colors cursor-pointer ${isActive ? "bg-emerald-100 text-emerald-700 font-semibold" : "text-slate-600 hover:bg-emerald-50 hover:text-emerald-600"
        }`}
        style={{ paddingLeft: `${(level * 12) + 12}px` }}
        onClick={(e) => {
          e.stopPropagation();
      ...
      >
        {hasChildren && (
          <span onClick={(e) => { e.stopPropagation(); setIsExpanded(!isExpanded); }} className="p-0.5 hover:bg-slate-200 rounded">
            {isExpanded ? <ChevronRight className="w-3.5 h-3.5 rotate-90 transition-transform" /> : <ChevronRight className="w-3.5 h-3.5 transition-transform" />}
          </span>
        )}
        {!hasChildren && <span className="w-3.5" />}
      ...
      {hasChildren && isExpanded && (
        <div className="mt-1 border-l border-slate-200 ml-6">
          {item.children!.map(child => (
            <SidebarItem key={child.id} item={child} activeSection={activeSection} onJump={onJump} level={level + 1} />
          ))}
        </div>
...
const ContentSection: React.FC<{ item: NavItem; level?: number }> = ({ item, level = 0 }) => {
  return (
    <section className="scroll-mt-24 mb-12">
      ...
      <div className={`mb-6 ${level === 0 ? 'pb-4 border-b-2 border-slate-200' : ''}`}>
        <div className="flex items-center gap-3">
          <h2 className={`${level === 0 ? 'text-3xl font-bold text-slate-900' :
            level === 1 ? 'text-2xl font-semibold text-slate-800 mt-8' :
              'text-xl font-medium text-slate-800 mt-6'
            }`}>
            {item.title}
          </h2>
        </div>
      ...
      {item.content && (
        <div className="text-slate-600 text-base leading-relaxed space-y-4 prose prose-emerald max-w-none">
          {item.content}
        </div>
      )}
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50/30 to-cyan-50">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex gap-8">
          ...
          <main className="flex-1 min-w-0 bg-white rounded-xl shadow-sm border border-slate-200 p-8 lg:p-12">
            ...
            <footer className="mt-20 pt-8 border-t border-slate-200 text-center">
              <p className="text-slate-500 mb-2">Need further assistance?</p>
              <a href="mailto:support@dsecuretech.com" className="text-emerald-600 font-medium hover:underline">
                Contact Support
              </a>
      ...
      <button
        onClick={scrollToTop}
        className={`fixed bottom-8 right-8 p-3 rounded-full bg-emerald-600 text-white shadow-lg transition-all transform hover:scale-110 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-600 z-50 ${shouldShowScrollTop ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10 pointer-events-none'
          }`}
      >
        <ArrowUp className="w-6 h-6" />
      </button>
