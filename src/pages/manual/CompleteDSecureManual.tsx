        ...
        content: (
          <>
            ...
            <div className="space-y-4">
              ...
              <div>
                <p className="text-slate-700 mb-2"><strong>Deleted Data Eraser - Complete:</strong> Deleted data erasure completed with verification summary.</p>
        ...
        content: (
          <>
            ...
            <div className="space-y-4">
              ...
              <div>
                <p className="text-slate-700 mb-2"><strong>Cloud Erase - Final Report:</strong> Final cloud erasure report with detailed results.</p>
