          ...
          <div className="space-y-6">
            ...
            <div className="border-2 border-purple-300 rounded-xl p-6 bg-gradient-to-r from-purple-50 to-purple-100/50">
              ...
              <p className="text-gray-700 mb-4 leading-relaxed">
                The Tools ribbon provides essential maintenance functions to keep your D-Secure installation up-to-date and running optimally. Regular updates ensure you have the latest security patches, algorithm improvements, and feature enhancements.
              </p>
