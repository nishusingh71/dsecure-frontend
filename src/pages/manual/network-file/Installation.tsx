          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-4 pb-6 border-b border-gray-100">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-600 text-sm mb-3">
                  The license agreement specifies that you may install the software on as many computers as your purchased licenses allow. It also clarifies that while the software permanently erases data, D-SecureTech is not liable for any data loss resulting from incorrect usage or configuration. By checking the "I accept the terms" checkbox and clicking Next, you agree to these terms and can proceed with installation.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 pb-6 border-b border-gray-100">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-700 leading-relaxed mb-3">
                  Select the folder where D-Secure File Eraser Network will be installed. The default location is <code className="bg-gray-100 px-2 py-1 rounded text-sm font-mono">C:\Program Files\D-Secure File Eraser Network\</code> on 64-bit systems or <code className="bg-gray-100 px-2 py-1 rounded text-sm font-mono">C:\Program Files (x86)\D-Secure File Eraser Network\</code> on 32-bit systems.
                </p>
                <p className="text-gray-600 text-sm mb-3">
                ...
                <ul className="space-y-3 mb-4">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-gray-600 text-sm">Creates a Start Menu entry under "D-Secure" for easy access from the Start button</span>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-green-600 mt-0.5 shrink-0" />
                    <div>
                      ...
                      <span className="text-gray-600 text-sm">Automatically opens D-Secure immediately after setup completes, allowing you to begin configuration</span>
                    </div>
                  </li>
                </ul>
                <p className="text-gray-600 text-sm">
