        ...
        content: (
          <>
            ...
            <ul className="list-disc list-inside space-y-2 text-slate-700 ml-4 mb-4">
              <li><strong>Product Name & Version</strong> — D-Secure Drive Eraser, Boot Edition v3.2.1</li>
            ...
            <IMG src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1772417779/qn7dcrwd4iojztir1rxp.png" alt="D-Secure Drive Eraser Welcome Screen with System Summary" />
          </>
        ),
      },
      {
        ...
        content: (
          <>
            ...
            <IMG src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1772417779/cfolkopf9z9ogx8wnulz.png" alt="Detecting Hardware" />
          </>
        ),
      },
      {
        ...
        children: [
          {
            ...
            content: (
              <>
                ...
                <IMG src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1772417779/hk7tniwoqceef728iwep.png" alt="Network Connection - Wi-Fi Networks" />
              </>
            ),
          },
          {
            ...
            content: (
              <>
                ...
                <IMG src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1772417779/sxw62hblrclb96aqnfyj.png" alt="Network Connection - LAN / Ethernet" />
              </>
            ),
          },
        ],
    ...
    children: [
      {
        ...
        content: (
          <>
            ...
            <IMG src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1772417780/hpjvvebp5ya3beufhslh.png" alt="Dashboard Overview" />
        ...
        children: [
          {
            ...
            content: (
              <>
                ...
                <IMG src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1772417780/qoi3ucpunnzcaeu1ljw6.png" alt="Step 1: Drive Detection" />
              </>
            ),
          },
          {
            ...
            content: (
              <>
                ...
                <IMG src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1772417780/xahasn88nboa91bq1jw1.png" alt="Step 2: Wipe Configuration" />
                ...
                <IMG src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1772417806/tzvonaywvrxvk4w8lzn2.png" alt="Wipe Configuration with Method Selected" />
              </>
            ),
          },
          {
            ...
            content: (
              <>
                ...
                <IMG src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1772417889/nvnofkrttcbjl7dsuzwl.png" alt="Step 3: Destructive Confirmation" />
              </>
            ),
          },
        ],
      },
      {
        ...
        content: (
          <>
            ...
            <IMG src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1772417889/oijdo5wfz4n7zesrrudt.png" alt="Reports & Compliance Certificates" />
          </>
        ),
      },
      {
        ...
        children: [
          {
            ...
            content: (
              <>
                ...
                <IMG src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1772417889/o4zgi0cowaixr9spcqkf.png" alt="Settings - General" />
                ...
                <IMG src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1772417889/mbz29lvbnlqcgpftgtp2.png" alt="Settings - Default Wipe Method" />
              </>
            ),
          },
        ],
        ...
        content: (
          <>
            ...
            <ul className="list-disc list-inside space-y-2 text-slate-700 ml-4 mb-4">
              ...
              <li><strong>License Type</strong> — Enterprise</li>
            </ul>
            ...
            <IMG src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1772417890/g7qsgoaib5aff4fz4lwp.png" alt="About Page" />
          </>
        ),
      },
      {
        ...
        content: (
          <>
            ...
            <IMG src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1772417890/awgnvxwdwcli7oyhxuwa.png" alt="Help Page - Top" />
            <h4 className="text-base font-semibold text-slate-800 mt-8 mb-3">Help Topics (Continued):</h4>
            <IMG src="https://res.cloudinary.com/dhwi5wevf/image/upload/v1772417893/yhvioc1r2sgrjkpt4xnx.png" alt="Help Page - Bottom" />
          </>
        ),
      },
    ],
