...
const InstallationPage = lazy(() => import("../pages/support/manual/InstallationPage"));
const InstallationGuideDetailed = lazy(() => import("../pages/manual/InstallationGuideDetailed"));
const SystemSetupPage = lazy(() => import("../pages/manual/SystemSetupPage"));
const WorkingWithDSecurePage = lazy(() => import("../pages/manual/WorkingWithDSecurePage"));
const DSecureFAQPage = lazy(() => import("../pages/manual/DSecureFAQPage"));
const ReportManagementPage = lazy(() => import("../pages/manual/ReportManagementPage"));
const ScheduleSettingsPage = lazy(() => import("../pages/manual/ScheduleSettingsPage"));
const FirstTimeSetupPage = lazy(() => import("../pages/support/manual/FirstTimeSetupPage"));
const UserInterfacePage = lazy(() => import("../pages/support/manual/UserInterfacePage"));
const QuickStartTutorial = lazy(() => import("../pages/support/manual/QuickstartPage"));
const OverwritePatternsPage = lazy(() => import("../pages/support/manual/OverwritePatternsPage"));
const CryptographicErasurePage = lazy(() => import("../pages/support/manual/CryptographicErasurePage"));
const PhysicalDestructionPage = lazy(() => import("../pages/support/manual/PhysicalDestructionPage"));
const VerificationMethodsPage = lazy(() => import("../pages/support/manual/VerificationMethodsPage"));
const WindowsSystemsPage = lazy(() => import("../pages/support/manual/WindowsSystemsPage"));
const MacOSSystemsPage = lazy(() => import("../pages/support/manual/MacOSSystemsPage"));
const LinuxSystemsPage = lazy(() => import("../pages/support/manual/LinuxSystemsPage"));
const CommonIssuesPage = lazy(() => import("../pages/support/manual/CommonIssuesPage"));
const ErrorCodesPage = lazy(() => import("../pages/support/manual/ErrorCodesPage"));
const MobileDevicesPage = lazy(() => import("../pages/support/manual/MobileDevicesPage"));
const EnterpriseServersPage = lazy(() => import("../pages/support/manual/EnterpriseServersPage"));
const BatchOperationsPage = lazy(() => import("../pages/support/manual/BatchOperationsPage"));
const RemoteManagementPage = lazy(() => import("../pages/support/manual/RemoteManagementPage"));
const ScriptingAutomationPage = lazy(() => import("../pages/support/manual/ScriptingAutomationPage"));
const CustomConfigurationsPage = lazy(() => import("../pages/support/manual/CustomConfigurationsPage"));
const ComplianceStandardsPage = lazy(() => import("../pages/support/manual/ComplianceStandardsPage"));
const CertificateGenerationPage = lazy(() => import("../pages/support/manual/CertificateGenerationPage"));
const AuditTrailsPage = lazy(() => import("../pages/support/manual/AuditTrailsPage"));
const ChainCustodyPage = lazy(() => import("../pages/support/manual/ChainCustodyPage"));
const PerformanceOptimizationPage = lazy(() => import("../pages/support/manual/PerformanceOptimizationPage"));
const RecoveryProceduresPage = lazy(() => import("../pages/support/manual/RecoveryProceduresPage"));
const WindowsIntroductionPage = lazy(() => import("../pages/support/manual/WindowsIntroductionPage"));
const WindowsBuiltinToolsPage = lazy(() => import("../pages/support/manual/WindowsBuiltinToolsPage"));
const WindowsSsdErasurePage = lazy(() => import("../pages/support/manual/WindowsSsdErasurePage"));
const WindowsStoragePage = lazy(() => import("../pages/support/manual/WindowsStoragePage"));
const WindowsPreparationPage = lazy(() => import("../pages/support/manual/WindowsPreparationPage"));
const WindowsTroubleshootingPage = lazy(() => import("../pages/support/manual/WindowsTroubleshootingPage"));
const WindowsEnterprisePage = lazy(() => import("../pages/support/manual/WindowsEnterprisePage"));
const WindowsRisksPage = lazy(() => import("../pages/support/manual/WindowsRisksPage"));
const WindowsFilesystemsPage = lazy(() => import("../pages/support/manual/WindowsFilesystemsPage"));
const WindowsSystemFilesPage = lazy(() => import("../pages/support/manual/WindowsSystemFilesPage"));
const WindowsResidualDataPage = lazy(() => import("../pages/support/manual/WindowsResidualDataPage"));
const WindowsSoftwareErasurePage = lazy(() => import("../pages/support/manual/WindowsSoftwareErasurePage"));
const WindowsCryptoErasurePage = lazy(() => import("../pages/support/manual/WindowsCryptoErasurePage"));
const WindowsMethodsComparisonPage = lazy(() => import("../pages/support/manual/WindowsMethodsComparisonPage"));
const WindowsCommandLinePage = lazy(() => import("../pages/support/manual/WindowsCommandLinePage"));
const PreInstallationPage = lazy(() => import("../pages/support/manual/PreInstallationPage"));
const DownloadInstallerPage = lazy(() => import("../pages/support/manual/DownloadInstallerPage"));
const LicenseActivationPage = lazy(() => import("../pages/support/manual/LicenseActivationPage"));
const InstallationSettingsPage = lazy(() => import("../pages/support/manual/InstallationSettingsPage"));
const InstallationProgressPage = lazy(() => import("../pages/support/manual/InstallationProgressPage"));
const SystemRequirementsPage = lazy(() => import("../pages/support/manual/SystemRequirementsPage"));
const SetupWizardPage = lazy(() => import("../pages/support/manual/SetupWizardPage"));
const FirstScanPage = lazy(() => import("../pages/support/manual/FirstScanPage"));
const KeyActivationPage = lazy(() => import("../pages/support/manual/KeyActivationPage"));
const FirewallSetupPage = lazy(() => import("../pages/support/manual/FirewallSetupPage"));
const MainDashboardPage = lazy(() => import("../pages/support/manual/MainDashboardPage"));
const NavigationPage = lazy(() => import("../pages/support/manual/NavigationPage"));
...
const DataGuardianAwardPage = lazy(() => import("../pages/DataGuardianAwardPage"));
