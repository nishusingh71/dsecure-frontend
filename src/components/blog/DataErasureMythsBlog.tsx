...
const DataErasureMythsBlog: React.FC = () => {
    return (
      ...
      <FAQSection faqs={blogFaqs["data-erasure-myths"]} />
      <EngagementSection blogId="data-erasure-myths" />
        </Reveal>
        <Reveal>
          <CommentSection blogId="data-erasure-myths" />
        </Reveal>
        <Reveal>
          <EnquiryForm 
            blogId="data-erasure-myths" 
            blogTitle="Data Erasure Myths" 
          />
        </Reveal>
      </section>
