...
const OnsiteVsOffsiteDestructionBlog: React.FC = () => {
    return (
      ...
      <FAQSection faqs={blogFaqs["onsite-vs-offsite-destruction"]} />
      <EngagementSection blogId="onsite-vs-offsite-destruction" />
        </Reveal>
        <Reveal>
          <CommentSection blogId="onsite-vs-offsite-destruction" />
        </Reveal>
        <Reveal>
          <EnquiryForm 
            blogId="onsite-vs-offsite-destruction" 
            blogTitle="Onsite Vs Offsite Destruction" 
          />
        </Reveal>
      </section>
