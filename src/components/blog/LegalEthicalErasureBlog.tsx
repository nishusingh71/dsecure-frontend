...
const LegalEthicalErasureBlog: React.FC = () => {
    return (
      ...
      <FAQSection faqs={blogFaqs["legal-ethical-erasure"]} />
      <EngagementSection blogId="legal-ethical-erasure" />
        </Reveal>
        <Reveal>
          <CommentSection blogId="legal-ethical-erasure" />
        </Reveal>
        <Reveal>
          <EnquiryForm 
            blogId="legal-ethical-erasure" 
            blogTitle="Legal Ethical Erasure" 
          />
        </Reveal>
      </section>
