...
const NISTTestedErasureSoftwareBlog: React.FC = () => {
    return (
      ...
      <FAQSection faqs={blogFaqs["n-i-s-t-tested-erasure-software"]} />
      <EngagementSection blogId="n-i-s-t-tested-erasure-software" />
        </Reveal>
        <Reveal>
          <CommentSection blogId="n-i-s-t-tested-erasure-software" />
        </Reveal>
        <Reveal>
          <EnquiryForm 
            blogId="n-i-s-t-tested-erasure-software" 
            blogTitle="N I S T Tested Erasure Software" 
          />
        </Reveal>
      </section>
