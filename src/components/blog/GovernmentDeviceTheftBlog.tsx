...
const GovernmentDeviceTheftBlog: React.FC = () => {
    return (
      ...
      <FAQSection faqs={blogFaqs["government-device-theft"]} />
      <EngagementSection blogId="government-device-theft" />
        </Reveal>
        <Reveal>
          <CommentSection blogId="government-device-theft" />
        </Reveal>
        <Reveal>
          <EnquiryForm 
            blogId="government-device-theft" 
            blogTitle="Government Device Theft" 
          />
        </Reveal>
      </section>
