...
const DoDWipingStandardBlog: React.FC = () => {
    return (
      ...
      <FAQSection faqs={blogFaqs["do-d-wiping-standard"]} />
      <EngagementSection blogId="do-d-wiping-standard" />
        </Reveal>
        <Reveal>
          <CommentSection blogId="do-d-wiping-standard" />
        </Reveal>
        <Reveal>
          <EnquiryForm 
            blogId="do-d-wiping-standard" 
            blogTitle="Do D Wiping Standard" 
          />
        </Reveal>
      </section>
