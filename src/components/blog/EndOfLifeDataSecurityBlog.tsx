...
const EndOfLifeDataSecurityBlog: React.FC = () => {
    return (
      ...
      <FAQSection faqs={blogFaqs["end-of-life-data-security"]} />
      <EngagementSection blogId="end-of-life-data-security" />
        </Reveal>
        <Reveal>
          <CommentSection blogId="end-of-life-data-security" />
        </Reveal>
        <Reveal>
          <EnquiryForm 
            blogId="end-of-life-data-security" 
            blogTitle="End Of Life Data Security" 
          />
        </Reveal>
      </section>
