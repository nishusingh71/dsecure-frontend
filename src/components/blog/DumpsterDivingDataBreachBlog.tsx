...
const DumpsterDivingDataBreachBlog: React.FC = () => {
    return (
      ...
      <FAQSection faqs={blogFaqs["dumpster-diving-data-breach"]} />
      <EngagementSection blogId="dumpster-diving-data-breach" />
        </Reveal>
        <Reveal>
          <CommentSection blogId="dumpster-diving-data-breach" />
        </Reveal>
        <Reveal>
          <EnquiryForm 
            blogId="dumpster-diving-data-breach" 
            blogTitle="Dumpster Diving Data Breach" 
          />
        </Reveal>
      </section>
