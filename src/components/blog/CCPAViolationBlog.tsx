...
const CCPAViolationBlog: React.FC = () => {
    return (
      ...
      <FAQSection faqs={blogFaqs["c-c-p-a-violation"]} />
      <EngagementSection blogId="c-c-p-a-violation" />
        </Reveal>
        <Reveal>
          <CommentSection blogId="c-c-p-a-violation" />
        </Reveal>
        <Reveal>
          <EnquiryForm 
            blogId="c-c-p-a-violation" 
            blogTitle="C C P A Violation" 
          />
        </Reveal>
      </section>
