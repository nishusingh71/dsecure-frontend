...
const ITADEnvironmentalBlog: React.FC = () => {
    return (
      ...
      <section className="w-full px-4 md:px-8 lg:px-16 py-8">
        <Reveal>
          <FAQSection faqs={blogFaqs["itad-environmental"]} />
          <EngagementSection blogId="itad-environmental" />
        </Reveal>
        <Reveal>
          <CommentSection blogId="itad-environmental" />
        </Reveal>
        <Reveal>
          <EnquiryForm 
            blogId="itad-environmental" 
            blogTitle="Itad Environmental" 
          />
        </Reveal>
      </section>
</div>
