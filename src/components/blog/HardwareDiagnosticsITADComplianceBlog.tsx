        ...
        <Reveal>
          <div className="text-center px-6 max-w-5xl mx-auto">
            ...
            <p className="text-xl text-slate-600 leading-relaxed">
              How professional hardware diagnostics enables reuse,
      ...
      <section className="px-4 md:px-8 lg:px-16 py-12">
        <Reveal>
          <div className="bg-white rounded-xl shadow border p-10 space-y-8 text-slate-700 leading-loose text-lg">
            <p>
              Hardware diagnostics is a critical process for IT Asset
              Disposition (ITAD) companies, refurbishers, recyclers, and
            ...
            <h2 className="text-2xl font-bold text-slate-900">
              How Hardware Diagnostics Works
            </h2>
            ...
            <p>
              D-Secure Hardware Diagnostics and D-Secure Mac Diagnostics are
              purpose-built tools for high-volume ITAD environments. They
            ...
            <p>
              Hardware diagnostics is not just a technical step but a compliance
        ...
        <Reveal>
          <div className="bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-600 rounded-xl shadow-lg p-10 mt-10 text-white">
            ...
            <p className="text-lg leading-loose mb-6">
              D-Secure's hardware diagnostics solutions help ITADs,
              refurbishers, and recyclers achieve R2v3 and e-Stewards compliance
              while maximizing asset value and reducing e-waste.
            </p>
            <Link
              to="/#products"
