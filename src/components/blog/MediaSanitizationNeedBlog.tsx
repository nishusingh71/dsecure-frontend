...
const MediaSanitizationNeedBlog: React.FC = () => {
    return (
      ...
      <FAQSection faqs={blogFaqs["media-sanitization-need"]} />
      <EngagementSection blogId="media-sanitization-need" />
        </Reveal>
        <Reveal>
          <CommentSection blogId="media-sanitization-need" />
        </Reveal>
        <Reveal>
          <EnquiryForm 
            blogId="media-sanitization-need" 
            blogTitle="Media Sanitization Need" 
          />
        </Reveal>
      </section>
