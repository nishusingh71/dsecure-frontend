...
const PostCovidDataDisposalBlog: React.FC = () => {
    return (
      ...
      <FAQSection faqs={blogFaqs["post-covid-data-disposal"]} />
      <EngagementSection blogId="post-covid-data-disposal" />
        </Reveal>
        <Reveal>
          <CommentSection blogId="post-covid-data-disposal" />
        </Reveal>
        <Reveal>
          <EnquiryForm 
            blogId="post-covid-data-disposal" 
            blogTitle="Post Covid Data Disposal" 
          />
        </Reveal>
      </section>
