...
const GovernmentITDisposalBlog: React.FC = () => {
    return (
      ...
      <section className="w-full px-4 md:px-8 lg:px-16 py-8">
        <Reveal>
          <EngagementSection blogId="government-i-t-disposal" />
        </Reveal>
        <Reveal>
          <CommentSection blogId="government-i-t-disposal" />
        </Reveal>
        <Reveal>
          <EnquiryForm 
            blogId="government-i-t-disposal" 
            blogTitle="Government I T Disposal" 
          />
        </Reveal>
      </section>
      ...
      <section className="w-full px-4 md:px-8 lg:px-16 py-8">
        <Reveal>
          <FAQSection faqs={blogFaqs["government-it-disposal"]} />
          <EngagementSection blogId="government-it-disposal" />
        </Reveal>
        <Reveal>
          <CommentSection blogId="government-it-disposal" />
        </Reveal>
        <Reveal>
          <EnquiryForm 
            blogId="government-it-disposal" 
            blogTitle="Government It Disposal" 
          />
        </Reveal>
      </section>
</div>
