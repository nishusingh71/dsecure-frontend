...
const EUCSRDBlog: React.FC = () => {
    return (
      ...
      <section className="w-full px-4 md:px-8 lg:px-16 py-8">
        <Reveal>
          <EngagementSection blogId="e-u-c-s-r-d" />
        </Reveal>
        <Reveal>
          <CommentSection blogId="e-u-c-s-r-d" />
        </Reveal>
        <Reveal>
          <EnquiryForm 
            blogId="e-u-c-s-r-d" 
            blogTitle="E U C S R D" 
          />
        </Reveal>
      </section>
      ...
      <section className="w-full px-4 md:px-8 lg:px-16 py-8">
        <Reveal>
          <FAQSection faqs={blogFaqs["eu-csrd"]} />
          <EngagementSection blogId="eu-csrd" />
        </Reveal>
        <Reveal>
          <CommentSection blogId="eu-csrd" />
        </Reveal>
        <Reveal>
          <EnquiryForm 
            blogId="eu-csrd" 
